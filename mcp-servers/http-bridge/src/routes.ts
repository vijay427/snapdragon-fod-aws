...
export function createRoutes(mcpClient: MCPClient): Router {
  const router = Router();
   ...
   */
  router.post('/vehicle/:vehicleId/activate', async (req: Request, res: Response) => {
   ...
   */
  router.post('/vehicle/:vehicleId/deactivate', async (req: Request, res: Response) => {
    const correlationId = (req as any).correlationId;
    const { vehicleId } = req.params;
   ...
   */
  router.get('/vehicle/:vehicleId/state', async (req: Request, res: Response) => {
    const correlationId = (req as any).correlationId;
    const { vehicleId } = req.params;
   ...
   */
  router.post('/vehicle/:vehicleId/advance-time', async (req: Request, res: Response) => {
    const correlationId = (req as any).correlationId;
    const { vehicleId } = req.params;
   ...
   */
  router.post('/vehicle/:vehicleId/reset', async (req: Request, res: Response) => {
    const correlationId = (req as any).correlationId;
    const { vehicleId } = req.params;
