...
const _bGI = "billingGroupId";
const _bGM = "billingGroupMetadata";
const _bGN = "billingGroupName";
const _bGP = "billingGroupProperties";
const _bM = "batchMode";
const _bN = "behaviorName";
...
const _cAo = "commandArn";
const _cAom = "completedAt";
const _cAon = "connectionAttribute";
const _cAr = "createdAt";
const _cC = "checkCompliant";
const _cCC = "clientCertificateConfig";
const _cCCA = "clientCertificateCallbackArn";
const _cCI = "caCertificateId";
const _cCP = "caCertificatePem";
const _cCS = "customCodeSigning";
const _cCa = "caCertificate";
const _cCan = "canceledChecks";
const _cCe = "certificateChain";
const _cCo = "compliantChecks";
const _cD = "creationDate";
const _cDS = "credentialDurationSeconds";
const _cDTA = "consecutiveDatapointsToAlarm";
const _cDTC = "consecutiveDatapointsToClear";
const _cDe = "certificateDescription";
const _cDo = "configurationDetails";
const _cDor = "correlationData";
const _cDr = "createDate";
const _cE = "commandExecutions";
const _cF = "customFields";
const _cFC = "canceledFindingsCount";
const _cI = "certificateId";
const _cIPI = "cognitoIdentityPoolId";
const _cIl = "clientId";
const _cIo = "commandId";
const _cL = "criteriaList";
const _cLl = "cloudwatchLogs";
const _cLo = "confidenceLevel";
const _cM = "cloudwatchMetric";
const _cMe = "certificateMode";
const _cN = "checkName";
const _cNe = "certificateName";
const _cNh = "channelName";
const _cO = "comparisonOperator";
const _cP = "certificatePem";
const _cPA = "certificateProviderArn";
const _cPN = "certificateProviderName";
const _cPNo = "commandParameterName";
const _cPOD = "certificatePathOnDevice";
const _cPe = "certificateProviders";
const _cPl = "clientProperties";
const _cRS = "checkRunStatus";
...
const _cTon = "confirmationToken";
const _cU = "confirmationUrl";
const _cV = "customerVersion";
...
const _dAIS = "disconnectAfterInSeconds";
const _dAL = "disableAllLogs";
const _dAMTR = "deleteAdditionalMetricsToRetain";
const _dAN = "defaultAuthorizerName";
const _dAT = "deleteAlertTargets";
const _dB = "deleteBehaviors";
const _dC = "destinationConfiguration";
const _dCA = "domainConfigurationArn";
const _dCAe = "deviceCertificateArn";
const _dCI = "defaultClientId";
const _dCIe = "deviceCertificateId";
const _dCN = "domainConfigurationName";
const _dCP = "datapointsCollectionPercentage";
const _dCS = "domainConfigurationStatus";
const _dCo = "domainConfigurations";
const _dD = "deviceDefender";
const _dDB = "dynamoDB";
const _dDBy = "dynamoDBv2";
const _dDIM = "deviceDefenderIndexingMode";
const _dDe = "deprecationDate";
const _dI = "deviceId";
const _dIM = "durationInMinutes";
const _dLL = "defaultLogLevel";
const _dM = "detailsMap";
const _dMEC = "deleteMetricsExportConfig";
const _dN = "displayName";
const _dNa = "databaseName";
const _dNi = "dimensionNames";
const _dNim = "dimensionName";
const _dNo = "domainName";
const _dOM = "dayOfMonth";
const _dOW = "dayOfWeek";
const _dP = "documentParameters";
const _dPV = "destinationPackageVersions";
const _dR = "disconnectReason";
const _dS = "durationSeconds";
const _dSA = "deleteScheduledAudits";
const _dSN = "deliveryStreamName";
const _dSe = "deleteStream";
const _dSes = "destinationSummaries";
const _dSo = "documentSource";
const _dT = "domainType";
...
const _eDx = "explicitDeny";
const _eED = "executionEndDate";
const _eI = "executionId";
const _eIS = "expiresInSec";
const _eITLP = "enableIoTLoggingParams";
const _eIn = "entryId";
const _eIr = "errorInfo";
const _eM = "exportMetric";
const _eMr = "errorMessage";
const _eN = "executionNumber";
const _eNP = "executionNamePrefix";
const _eOCSPC = "enableOCSPCheck";
const _eP = "effectivePolicies";
const _eR = "exponentialRate";
const _eRr = "errorReason";
const _eS = "executionSummaries";
const _eSD = "executionStartDate";
const _eT = "endTime";
...
const _fCa = "failedChecks";
const _fCo = "forceCanceled";
const _fD = "forceDelete";
const _fDAWSJ = "forceDeleteAWSJob";
const _fFC = "failedFindingsCount";
const _fI = "findingId";
const _fIi = "findingIds";
const _fIil = "fileId";
const _fL = "fileLocation";
const _fM = "fleetMetrics";
const _fN = "fileName";
const _fT = "failureType";
const _fTi = "findingTime";
const _fTil = "fileType";
const _fV = "fileVersion";
const _fi = "files";
const _fil = "filter";
const _fin = "finding";
const _find = "findings";
const _fo = "force";
const _fr = "frequency";
const _gA = "groupArn";
const _gI = "generationId";
const _gL = "geoLocations";
const _gN = "groupName";
const _h = "http";
...
const _hQ = "httpQuery";
const _hUC = "httpUrlConfiguration";
const _hUP = "httpUrlProperties";
const _hUS = "httpUrlSummary";
const _he = "headers";
const _i = "index";
const _iA = "iotAnalytics";
const _iAO = "isAscendingOrder";
const _iAs = "isAuthenticated";
const _iC = "isConcurrent";
const _iCI = "issuerCertificateIdentifier";
...
const _iFB = "inputFileBucket";
const _iFK = "inputFileKey";
const _iI = "issuerId";
const _iN = "indexName";
const _iNn = "inputName";
const _iNnd = "indexNames";
const _iOAV = "includeOnlyActiveViolations";
const _iPC = "inProgressChecks";
...
const _jERCo = "jobExecutionsRetryConfig";
const _jES = "jobExecutionSummary";
const _jI = "jobId";
const _jPD = "jobProcessDetails";
const _jT = "jobTemplates";
const _jTA = "jobTemplateArn";
...
const _lMRD = "lastModelRefreshDate";
const _lOP = "loggingOptionsPayload";
const _lSA = "listSuppressedAlerts";
const _lSCD = "lastStatusChangeDate";
const _lSF = "listSuppressedFindings";
const _lT = "logTarget";
const _lTC = "logTargetConfigurations";
const _lUA = "lastUpdatedAt";
const _lVT = "lastViolationTime";
const _lVV = "lastViolationValue";
const _la = "latitude";
const _lo = "location";
...
const _nB = "notBefore";
const _nCC = "nonCompliantChecks";
const _nCR = "nonCompliantResource";
const _nCRC = "nonCompliantResourcesCount";
...
const _oU = "otaUpdates";
const _oUA = "otaUpdateArn";
const _oUF = "otaUpdateFiles";
...
const _pAPVE = "putAssetPropertyValueEntries";
const _pAo = "policyArn";
const _pAr = "propagatingAttributes";
const _pAro = "propertyAlias";
const _pD = "pendingDeletion";
const _pDo = "policyDocument";
const _pDol = "policyDocuments";
const _pF = "payloadField";
const _pFI = "payloadFormatIndicator";
const _pFTSP = "publishFindingToSnsParams";
const _pG = "parentGroup";
const _pGN = "parentGroupName";
const _pGNa = "parentGroupNames";
const _pI = "putItem";
const _pIr = "propertyId";
const _pIri = "principalId";
const _pK = "partitionKey";
const _pN = "packageName";
const _pNTA = "policyNamesToAdd";
const _pNTS = "policyNamesToSkip";
const _pNo = "policyName";
const _pOB = "previousOwnedBy";
const _pP = "percentageProgress";
const _pPH = "preProvisioningHook";
...
const _pVIo = "policyVersionIdentifier";
const _pVS = "packageVersionSummaries";
const _pVa = "payloadVersion";
...
const _pe = "period";
const _per = "percents";
const _perc = "percentiles";
const _perce = "percent";
const _pl = "platform";
const _po = "ports";
const _pr = "principal";
const _pre = "prefix";
...
const _rCeg = "registrationCode";
const _rD = "ruleDisabled";
const _rDPVP = "replaceDefaultPolicyVersionParams";
const _rDe = "reasonDescription";
...
const _rN = "ruleName";
const _rPPH = "removePreProvisioningHook";
const _rR = "relatedResources";
const _rRe = "rejectReason";
const _rT = "reportType";
const _rTPTG = "rootToParentThingGroups";
const _rTT = "removeThingType";
const _rTe = "responseTopic";
const _rTes = "resourceType";
const _re = "resources";
const _rec = "recipe";
const _recu = "recursive";
const _reg = "regex";
const _res = "result";
const _ru = "rule";
const _rul = "rules";
...
const _sAI = "suppressedAlertsIncluded";
const _sAN = "scheduledAuditName";
const _sAc = "scheduledAudits";
const _sAe = "searchableAttributes";
const _sAi = "signatureAlgorithm";
const _sAt = "startedAt";
const _sAtr = "streamArn";
const _sC = "schedulingConfig";
const _sCA = "serverCertificateArns";
const _sCAe = "serverCertificateArn";
const _sCC = "serverCertificateConfig";
const _sCS = "serverCertificateStatus";
const _sCSD = "serverCertificateStatusDetail";
const _sCe = "serverCertificates";
const _sCt = "statusCode";
const _sCu = "successCount";
const _sD = "signingDisabled";
...
const _sNCRC = "suppressedNonCompliantResourcesCount";
...
const _sPIe = "securityProfileIdentifier";
const _sPN = "securityProfileName";
const _sPNi = "signingProfileName";
const _sPP = "signingProfileParameter";
...
const _sVtr = "streamVersion";
const _sVtri = "stringValue";
const _s_ = "s3";
...
const _su = "summaries";
const _sum = "sum";
const _sup = "suppressions";
const _t = "timestream";
const _tA = "thingArn";
const _tAA = "targetAwsAccount";
const _tAa = "targetArn";
const _tAe = "termsAggregation";
const _tAem = "templateArn";
const _tAh = "thingAttribute";
const _tAo = "topicArn";
const _tB = "templateBody";
const _tC = "tlsConfig";
const _tCA = "transferredCertificateArn";
const _tCIM = "thingConnectivityIndexingMode";
const _tCN = "targetCheckNames";
const _tCi = "timeoutConfig";
const _tCl = "tlsContext";
const _tCo = "totalCount";
const _tCot = "totalChecks";
const _tD = "transferData";
const _tDCSD = "trainingDataCollectionStartDate";
const _tDr = "transferDate";
const _tET = "taskEndTime";
const _tFC = "totalFindingsCount";
const _tG = "thingGroups";
const _tGA = "thingGroupArn";
const _tGD = "thingGroupDescription";
const _tGI = "thingGroupId";
const _tGIC = "thingGroupIndexingConfiguration";
const _tGIM = "thingGroupIndexingMode";
const _tGM = "thingGroupMetadata";
const _tGN = "thingGroupNames";
const _tGNh = "thingGroupName";
const _tGP = "thingGroupProperties";
const _tGTA = "thingGroupsToAdd";
const _tGTR = "thingGroupsToRemove";
const _tI = "taskId";
const _tIC = "thingIndexingConfiguration";
...
const _tM = "transferMessage";
const _tN = "thingName";
const _tNa = "targetName";
const _tNab = "tableName";
const _tNe = "templateName";
const _tNr = "trackerName";
...
const _tSPK = "tokenSigningPublicKeys";
const _tST = "taskStartTime";
const _tSa = "targetSelection";
const _tSas = "taskStatistics";
const _tSask = "taskSummary";
const _tSo = "tokenSignature";
const _tT = "taskType";
const _tTA = "thingTypeArn";
const _tTD = "thingTypeDescription";
const _tTI = "thingTypeId";
...
const _uB = "useBase64";
const _uCACP = "updateCACertificateParams";
const _uD = "undoDeprecate";
const _uDCP = "updateDeviceCertificateParams";
const _uDV = "unsetDefaultVersion";
const _uP = "userProperties";
const _uPAV = "usePrefixAttributeValue";
const _uPK = "userPropertyKey";
const _ur = "url";
const _us = "username";
const _v = "values";
...
const _vIi = "violationIds";
const _vIp = "vpcId";
const _vN = "versionName";
const _vNe = "versionNumber";
const _vP = "vpcProperties";
const _vR = "validationResult";
const _vRS = "validationResultSummaries";
const _vS = "verificationState";
const _vSD = "verificationStateDescription";
const _vST = "violationStartTime";
const _vUBJC = "versionUpdateByJobsConfig";
const _va = "value";
const _val = "validity";
const _vali = "valid";
...
const n0 = "com.amazonaws.iot";
import { TypeRegistry } from "@smithy/core/schema";
import { CertificateConflictException as __CertificateConflictException, CertificateStateException as __CertificateStateException, CertificateValidationException as __CertificateValidationException, ConflictException as __ConflictException, ConflictingResourceUpdateException as __ConflictingResourceUpdateException, DeleteConflictException as __DeleteConflictException, IndexNotReadyException as __IndexNotReadyException, InternalException as __InternalException, InternalFailureException as __InternalFailureException, InternalServerException as __InternalServerException, InvalidAggregationException as __InvalidAggregationException, InvalidQueryException as __InvalidQueryException, InvalidRequestException as __InvalidRequestException, InvalidResponseException as __InvalidResponseException, InvalidStateTransitionException as __InvalidStateTransitionException, LimitExceededException as __LimitExceededException, MalformedPolicyException as __MalformedPolicyException, NotConfiguredException as __NotConfiguredException, RegistrationCodeValidationException as __RegistrationCodeValidationException, ResourceAlreadyExistsException as __ResourceAlreadyExistsException, ResourceNotFoundException as __ResourceNotFoundException, ResourceRegistrationFailureException as __ResourceRegistrationFailureException, ServiceQuotaExceededException as __ServiceQuotaExceededException, ServiceUnavailableException as __ServiceUnavailableException, SqlParseException as __SqlParseException, TaskAlreadyExistsException as __TaskAlreadyExistsException, ThrottlingException as __ThrottlingException, TransferAlreadyCompletedException as __TransferAlreadyCompletedException, TransferConflictException as __TransferConflictException, UnauthorizedException as __UnauthorizedException, ValidationException as __ValidationException, VersionConflictException as __VersionConflictException, VersionsLimitExceededException as __VersionsLimitExceededException, } from "../models/errors";
import { IoTServiceException as __IoTServiceException } from "../models/IoTServiceException";
export var ConnectivityApiThingName = [0, n0, _CATN, 8, 0];
export var PackageVersionRecipe = [0, n0, _PVR, 8, 0];
export var PrivateKey = [0, n0, _PK, 8, 0];
export var ResourceDescription = [0, n0, _RD, 8, 0];
export var AbortConfig = [3, n0, _AC, 0, [_cL], [() => AbortCriteriaList]];
export var AbortCriteria = [3, n0, _ACb, 0, [_fT, _a, _tP, _mNOET], [0, 0, 1, 1]];
...
export var AddThingsToThingGroupParams = [3, n0, _ATTTGP, 0, [_tGN, _oDG], [64 | 0, 2]];
...
export var AddThingToBillingGroupResponse = [3, n0, _ATTBGRd, 0, [], []];
export var AddThingToThingGroupRequest = [
    3,
    n0,
    _ATTTGR,
    0,
    [_tGNh, _tGA, _tN, _tA, _oDG],
    [0, 0, 0, 0, 2],
];
export var AddThingToThingGroupResponse = [3, n0, _ATTTGRd, 0, [], []];
export var AggregationType = [3, n0, _AT, 0, [_n, _v], [0, 64 | 0]];
export var AlertTarget = [3, n0, _ATl, 0, [_aTA, _rA], [0, 0]];
export var Allowed = [3, n0, _Al, 0, [_p], [() => Policies]];
...
export var AssociateSbomWithPackageVersionRequest = [
    3,
    n0,
    _ASWPVR,
    0,
...
export var AssociateTargetsWithJobResponse = [3, n0, _ATWJRs, 0, [_jA, _jI, _d], [0, 0, 0]];
export var AttachPolicyRequest = [3, n0, _APR, 0, [_pNo, _tar], [[0, 1], 0]];
...
export var AttachSecurityProfileResponse = [3, n0, _ASPRt, 0, [], []];
...
export var AttachThingPrincipalResponse = [3, n0, _ATPRt, 0, [], []];
export var AttributePayload = [3, n0, _AP, 0, [_at, _m], [128 | 0, 2]];
export var AuditCheckConfiguration = [3, n0, _ACC, 0, [_en, _co], [2, 128 | 0]];
...
export var AuditMitigationActionsTaskMetadata = [3, n0, _AMATM, 0, [_tI, _sT, _tS], [0, 4, 0]];
export var AuditMitigationActionsTaskTarget = [
    ...
    0,
    [_aTI, _fIi, _aCTRCF],
    [0, 64 | 0, [2, n0, _ACTRCF, 0, 0, 64 | 0]],
];
export var AuditNotificationTarget = [3, n0, _ANT, 0, [_tAa, _rA, _en], [0, 0, 2]];
...
export var AuditTaskMetadata = [3, n0, _ATM, 0, [_tI, _tS, _tT], [0, 0, 0]];
export var AuthInfo = [3, n0, _AI, 0, [_aT, _re], [0, 64 | 0]];
export var AuthorizerConfig = [3, n0, _ACu, 0, [_dAN, _aAO], [0, 2]];
...
export var AuthorizerSummary = [3, n0, _ASu, 0, [_aNu, _aA], [0, 0]];
...
export var AwsJobAbortConfig = [3, n0, _AJAC, 0, [_aCL], [() => AwsJobAbortCriteriaList]];
export var AwsJobAbortCriteria = [3, n0, _AJACw, 0, [_fT, _a, _tP, _mNOET], [0, 0, 1, 1]];
export var AwsJobExecutionsRolloutConfig = [
    ...
    0,
    [_mPM, _eR],
    [1, () => AwsJobExponentialRolloutRate],
];
...
export var AwsJobPresignedUrlConfig = [3, n0, _AJPUC, 0, [_eIS], [1]];
...
export var BillingGroupMetadata = [3, n0, _BGM, 0, [_cD], [4]];
export var BillingGroupProperties = [3, n0, _BGP, 0, [_bGD], [0]];
export var Bucket = [3, n0, _Bu, 0, [_kV, _cou], [0, 1]];
export var BucketsAggregationType = [3, n0, _BAT, 0, [_tAe], [() => TermsAggregation]];
export var CACertificate = [3, n0, _CAC, 0, [_cAe, _cI, _st, _cD], [0, 0, 0, 4]];
...
export var CancelAuditMitigationActionsTaskRequest = [3, n0, _CAMATR, 0, [_tI], [[0, 1]]];
export var CancelAuditMitigationActionsTaskResponse = [3, n0, _CAMATRa, 0, [], []];
export var CancelAuditTaskRequest = [3, n0, _CATR, 0, [_tI], [[0, 1]]];
export var CancelAuditTaskResponse = [3, n0, _CATRa, 0, [], []];
export var CancelCertificateTransferRequest = [3, n0, _CCTR, 0, [_cI], [[0, 1]]];
export var CancelDetectMitigationActionsTaskRequest = [3, n0, _CDMATR, 0, [_tI], [[0, 1]]];
export var CancelDetectMitigationActionsTaskResponse = [3, n0, _CDMATRa, 0, [], []];
...
export var CancelJobResponse = [3, n0, _CJRa, 0, [_jA, _jI, _d], [0, 0, 0]];
export var Certificate = [3, n0, _C, 0, [_cAe, _cI, _st, _cMe, _cD], [0, 0, 0, 0, 4]];
export var CertificateConflictException = [
    -3,
    n0,
    _CCE,
    {
...
export var CertificateProviderSummary = [3, n0, _CPS, 0, [_cPN, _cPA], [0, 0]];
...
export var CertificateValidity = [3, n0, _CV, 0, [_nB, _nA], [4, 4]];
export var ClearDefaultAuthorizerRequest = [3, n0, _CDAR, 0, [], []];
export var ClearDefaultAuthorizerResponse = [3, n0, _CDARl, 0, [], []];
export var ClientCertificateConfig = [3, n0, _CCC, 0, [_cCCA], [0]];
export var CloudwatchAlarmAction = [3, n0, _CAA, 0, [_rA, _aNl, _sR, _sV], [0, 0, 0, 0]];
export var CloudwatchLogsAction = [3, n0, _CLA, 0, [_rA, _lGN, _bM], [0, 0, 2]];
...
export var CodeSigningCertificateChain = [3, n0, _CSCC, 0, [_cNe, _iD], [0, 0]];
export var CodeSigningSignature = [3, n0, _CSS, 0, [_iD], [21]];
export var CommandExecutionResult = [3, n0, _CER, 0, [_S, _B_, _BIN], [0, 2, 21]];
export var CommandExecutionSummary = [
    3,
    n0,
    _CES,
    0,
...
export var CommandPayload = [3, n0, _CPo, 0, [_con, _cTo], [21, 0]];
export var CommandSummary = [
    3,
    n0,
    _CSo,
    0,
    [_cAo, _cIo, _dN, _dep, _cAr, _lUA, _pD],
    [0, 0, 0, 2, 4, 4, 2],
];
export var Configuration = [3, n0, _Co, 0, [_E], [2]];
export var ConfigurationDetails = [3, n0, _CDo, 0, [_cS, _eC, _eMr], [0, 0, 0]];
export var ConfirmTopicRuleDestinationRequest = [3, n0, _CTRDR, 0, [_cTon], [[0, 1]]];
export var ConfirmTopicRuleDestinationResponse = [3, n0, _CTRDRo, 0, [], []];
...
export var CreateAuditSuppressionResponse = [3, n0, _CASRr, 0, [], []];
...
export var CreateAuthorizerResponse = [3, n0, _CARr, 0, [_aNu, _aA], [0, 0]];
...
export var CreateBillingGroupResponse = [3, n0, _CBGRr, 0, [_bGN, _bGA, _bGI], [0, 0, 0]];
...
export var CreateCertificateFromCsrResponse = [3, n0, _CCFCRr, 0, [_cAe, _cI, _cP], [0, 0, 0]];
export var CreateCertificateProviderRequest = [
    3,
    n0,
    _CCPR,
    0,
...
export var CreateCertificateProviderResponse = [3, n0, _CCPRr, 0, [_cPN, _cPA], [0, 0]];
export var CreateCommandRequest = [
    3,
    n0,
    _CCR,
    0,
...
export var CreateCommandResponse = [3, n0, _CCRr, 0, [_cIo, _cAo], [0, 0]];
...
export var CreateCustomMetricResponse = [3, n0, _CCMRr, 0, [_mNe, _mA], [0, 0]];
...
export var CreateDimensionResponse = [3, n0, _CDRr, 0, [_n, _ar], [0, 0]];
...
export var CreateDomainConfigurationResponse = [3, n0, _CDCRr, 0, [_dCN, _dCA], [0, 0]];
...
export var CreateFleetMetricResponse = [3, n0, _CFMRr, 0, [_mNe, _mA], [0, 0]];
...
export var CreateJobResponse = [3, n0, _CJRre, 0, [_jA, _jI, _d], [0, 0, 0]];
...
export var CreateJobTemplateResponse = [3, n0, _CJTRr, 0, [_jTA, _jTI], [0, 0]];
...
export var CreateMitigationActionResponse = [3, n0, _CMARr, 0, [_aAc, _aI], [0, 0]];
...
export var CreatePackageResponse = [
    ...
    0,
    [_pN, _pA, _d],
    [0, 0, [() => ResourceDescription, 0]],
];
export var CreatePackageVersionRequest = [
    3,
    n0,
    _CPVR,
    0,
...
export var CreatePolicyResponse = [3, n0, _CPRrea, 0, [_pNo, _pAo, _pDo, _pVI], [0, 0, 0, 0]];
...
export var CreateProvisioningClaimRequest = [3, n0, _CPCR, 0, [_tNe], [[0, 1]]];
...
export var CreateRoleAliasResponse = [3, n0, _CRARr, 0, [_rAo, _rAA], [0, 0]];
...
export var CreateScheduledAuditResponse = [3, n0, _CSARr, 0, [_sAAc], [0]];
...
export var CreateSecurityProfileResponse = [3, n0, _CSPRr, 0, [_sPN, _sPA], [0, 0]];
...
export var CreateStreamResponse = [3, n0, _CSRr, 0, [_sIt, _sAtr, _d, _sVtr], [0, 0, 0, 1]];
...
export var CreateThingGroupResponse = [3, n0, _CTGRr, 0, [_tGNh, _tGA, _tGI], [0, 0, 0]];
...
export var CreateThingResponse = [3, n0, _CTRr, 0, [_tN, _tA, _tIh], [0, 0, 0]];
...
export var CreateThingTypeResponse = [3, n0, _CTTRr, 0, [_tTN, _tTA, _tTI], [0, 0, 0]];
...
export var DeleteAccountAuditConfigurationResponse = [3, n0, _DAACRe, 0, [], []];
...
export var DeleteAuditSuppressionResponse = [3, n0, _DASRe, 0, [], []];
export var DeleteAuthorizerRequest = [3, n0, _DAR, 0, [_aNu], [[0, 1]]];
export var DeleteAuthorizerResponse = [3, n0, _DARe, 0, [], []];
...
export var DeleteBillingGroupResponse = [3, n0, _DBGRe, 0, [], []];
export var DeleteCACertificateRequest = [3, n0, _DCACR, 0, [_cI], [[0, 1]]];
export var DeleteCACertificateResponse = [3, n0, _DCACRe, 0, [], []];
export var DeleteCertificateProviderRequest = [3, n0, _DCPR, 0, [_cPN], [[0, 1]]];
export var DeleteCertificateProviderResponse = [3, n0, _DCPRe, 0, [], []];
...
export var DeleteCommandExecutionRequest = [
    3,
    n0,
    _DCER,
    0,
...
export var DeleteCommandExecutionResponse = [3, n0, _DCERe, 0, [], []];
export var DeleteCommandRequest = [3, n0, _DCRe, 0, [_cIo], [[0, 1]]];
export var DeleteCommandResponse = [3, n0, _DCRel, 0, [_sCt], [[1, 32]]];
...
export var DeleteCustomMetricRequest = [3, n0, _DCMR, 0, [_mNe], [[0, 1]]];
export var DeleteCustomMetricResponse = [3, n0, _DCMRe, 0, [], []];
export var DeleteDimensionRequest = [3, n0, _DDR, 0, [_n], [[0, 1]]];
export var DeleteDimensionResponse = [3, n0, _DDRe, 0, [], []];
export var DeleteDomainConfigurationRequest = [3, n0, _DDCR, 0, [_dCN], [[0, 1]]];
export var DeleteDomainConfigurationResponse = [3, n0, _DDCRe, 0, [], []];
...
export var DeleteDynamicThingGroupResponse = [3, n0, _DDTGRe, 0, [], []];
export var DeleteFleetMetricRequest = [
    3,
    n0,
    _DFMR,
    0,
...
export var DeleteJobTemplateRequest = [3, n0, _DJTR, 0, [_jTI], [[0, 1]]];
export var DeleteMitigationActionRequest = [3, n0, _DMAR, 0, [_aN], [[0, 1]]];
export var DeleteMitigationActionResponse = [3, n0, _DMARe, 0, [], []];
...
export var DeleteOTAUpdateResponse = [3, n0, _DOTAURe, 0, [], []];
...
export var DeletePackageVersionRequest = [
    3,
    n0,
    _DPVR,
    0,
...
export var DeletePolicyRequest = [3, n0, _DPRel, 0, [_pNo], [[0, 1]]];
...
export var DeleteProvisioningTemplateRequest = [3, n0, _DPTR, 0, [_tNe], [[0, 1]]];
export var DeleteProvisioningTemplateResponse = [3, n0, _DPTRe, 0, [], []];
...
export var DeleteProvisioningTemplateVersionResponse = [3, n0, _DPTVRe, 0, [], []];
export var DeleteRegistrationCodeRequest = [3, n0, _DRCR, 0, [], []];
export var DeleteRegistrationCodeResponse = [3, n0, _DRCRe, 0, [], []];
export var DeleteRoleAliasRequest = [3, n0, _DRAR, 0, [_rAo], [[0, 1]]];
export var DeleteRoleAliasResponse = [3, n0, _DRARe, 0, [], []];
export var DeleteScheduledAuditRequest = [3, n0, _DSAR, 0, [_sAN], [[0, 1]]];
export var DeleteScheduledAuditResponse = [3, n0, _DSARe, 0, [], []];
...
export var DeleteSecurityProfileResponse = [3, n0, _DSPRe, 0, [], []];
export var DeleteStreamRequest = [3, n0, _DSR, 0, [_sIt], [[0, 1]]];
export var DeleteStreamResponse = [3, n0, _DSRe, 0, [], []];
...
export var DeleteThingGroupResponse = [3, n0, _DTGRe, 0, [], []];
...
export var DeleteThingResponse = [3, n0, _DTRe, 0, [], []];
export var DeleteThingTypeRequest = [3, n0, _DTTR, 0, [_tTN], [[0, 1]]];
export var DeleteThingTypeResponse = [3, n0, _DTTRe, 0, [], []];
export var DeleteTopicRuleDestinationRequest = [3, n0, _DTRDR, 0, [_ar], [[0, 1]]];
export var DeleteTopicRuleDestinationResponse = [3, n0, _DTRDRe, 0, [], []];
export var DeleteTopicRuleRequest = [3, n0, _DTRR, 0, [_rN], [[0, 1]]];
...
export var Denied = [3, n0, _De, 0, [_iDm, _eDx], [() => ImplicitDeny, () => ExplicitDeny]];
export var DeprecateThingTypeRequest = [3, n0, _DTTRep, 0, [_tTN, _uD], [[0, 1], 2]];
export var DeprecateThingTypeResponse = [3, n0, _DTTRepr, 0, [], []];
export var DescribeAccountAuditConfigurationRequest = [3, n0, _DAACRes, 0, [], []];
...
export var DescribeAuditFindingRequest = [3, n0, _DAFR, 0, [_fI], [[0, 1]]];
export var DescribeAuditFindingResponse = [3, n0, _DAFRe, 0, [_fin], [() => AuditFinding]];
export var DescribeAuditMitigationActionsTaskRequest = [3, n0, _DAMATR, 0, [_tI], [[0, 1]]];
...
export var DescribeAuditTaskRequest = [3, n0, _DATR, 0, [_tI], [[0, 1]]];
...
export var DescribeAuthorizerRequest = [3, n0, _DARes, 0, [_aNu], [[0, 1]]];
...
export var DescribeBillingGroupRequest = [3, n0, _DBGRes, 0, [_bGN], [[0, 1]]];
...
export var DescribeCACertificateRequest = [3, n0, _DCACRes, 0, [_cI], [[0, 1]]];
...
export var DescribeCertificateProviderRequest = [3, n0, _DCPRes, 0, [_cPN], [[0, 1]]];
export var DescribeCertificateProviderResponse = [
    3,
    n0,
    _DCPResc,
    0,
...
export var DescribeCertificateRequest = [3, n0, _DCRes, 0, [_cI], [[0, 1]]];
...
export var DescribeCustomMetricRequest = [3, n0, _DCMRes, 0, [_mNe], [[0, 1]]];
...
export var DescribeDefaultAuthorizerRequest = [3, n0, _DDAR, 0, [], []];
...
export var DescribeDetectMitigationActionsTaskRequest = [3, n0, _DDMATR, 0, [_tI], [[0, 1]]];
...
export var DescribeDimensionRequest = [3, n0, _DDRes, 0, [_n], [[0, 1]]];
export var DescribeDimensionResponse = [
    3,
    n0,
    _DDResc,
    0,
    [_n, _ar, _ty, _sVt, _cD, _lMD],
    [0, 0, 0, 64 | 0, 4, 4],
];
export var DescribeDomainConfigurationRequest = [3, n0, _DDCRes, 0, [_dCN], [[0, 1]]];
...
export var DescribeEncryptionConfigurationRequest = [3, n0, _DECR, 0, [], []];
export var DescribeEncryptionConfigurationResponse = [
    3,
    n0,
    _DECRe,
    0,
...
export var DescribeEndpointResponse = [3, n0, _DERe, 0, [_eA], [0]];
export var DescribeEventConfigurationsRequest = [3, n0, _DECRes, 0, [], []];
...
export var DescribeFleetMetricRequest = [3, n0, _DFMRe, 0, [_mNe], [[0, 1]]];
...
export var DescribeIndexRequest = [3, n0, _DIR, 0, [_iN], [[0, 1]]];
export var DescribeIndexResponse = [3, n0, _DIRe, 0, [_iN, _iSn, _sc], [0, 0, 0]];
...
export var DescribeJobExecutionResponse = [3, n0, _DJERes, 0, [_exe], [() => JobExecution]];
...
export var DescribeJobResponse = [3, n0, _DJRes, 0, [_dSo, _j], [0, () => Job]];
export var DescribeJobTemplateRequest = [3, n0, _DJTRe, 0, [_jTI], [[0, 1]]];
...
export var DescribeMitigationActionRequest = [3, n0, _DMARes, 0, [_aN], [[0, 1]]];
...
export var DescribeProvisioningTemplateRequest = [3, n0, _DPTRes, 0, [_tNe], [[0, 1]]];
...
export var DescribeRoleAliasRequest = [3, n0, _DRARes, 0, [_rAo], [[0, 1]]];
...
export var DescribeScheduledAuditRequest = [3, n0, _DSARes, 0, [_sAN], [[0, 1]]];
...
export var DescribeSecurityProfileRequest = [3, n0, _DSPRes, 0, [_sPN], [[0, 1]]];
...
export var DescribeStreamRequest = [3, n0, _DSRes, 0, [_sIt], [[0, 1]]];
export var DescribeStreamResponse = [3, n0, _DSResc, 0, [_sItr], [() => StreamInfo]];
export var DescribeThingGroupRequest = [3, n0, _DTGRes, 0, [_tGNh], [[0, 1]]];
...
export var DescribeThingRegistrationTaskRequest = [3, n0, _DTRTR, 0, [_tI], [[0, 1]]];
...
export var DescribeThingRequest = [3, n0, _DTRes, 0, [_tN], [[0, 1]]];
...
export var DescribeThingTypeRequest = [3, n0, _DTTRes, 0, [_tTN], [[0, 1]]];
...
export var Destination = [3, n0, _Des, 0, [_sDe], [() => S3Destination]];
export var DetachPolicyRequest = [3, n0, _DPRet, 0, [_pNo, _tar], [[0, 1], 0]];
...
export var DetachSecurityProfileResponse = [3, n0, _DSPReta, 0, [], []];
...
export var DetachThingPrincipalResponse = [3, n0, _DTPRe, 0, [], []];
export var DetectMitigationActionExecution = [
    3,
    n0,
    _DMAE,
    0,
...
export var DisableTopicRuleRequest = [3, n0, _DTRRi, 0, [_rN], [[0, 1]]];
export var DisassociateSbomFromPackageVersionRequest = [
    3,
    n0,
    _DSFPVR,
    0,
...
export var DocumentParameter = [3, n0, _DP, 0, [_ke, _d, _reg, _exa, _o], [0, 0, 0, 0, 2]];
export var DomainConfigurationSummary = [3, n0, _DCS, 0, [_dCN, _dCA, _sTe], [0, 0, 0]];
...
export var DynamoDBv2Action = [3, n0, _DDBAy, 0, [_rA, _pI], [0, () => PutItemInput]];
export var EffectivePolicy = [3, n0, _EP, 0, [_pNo, _pAo, _pDo], [0, 0, 0]];
export var ElasticsearchAction = [3, n0, _EA, 0, [_rA, _end, _i, _ty, _id], [0, 0, 0, 0, 0]];
export var EnableIoTLoggingParams = [3, n0, _EITLP, 0, [_rAFL, _lL], [0, 0]];
export var EnableTopicRuleRequest = [3, n0, _ETRR, 0, [_rN], [[0, 1]]];
export var ErrorInfo = [3, n0, _EI, 0, [_cod, _me], [0, 0]];
export var ExplicitDeny = [3, n0, _ED, 0, [_p], [() => Policies]];
...
export var Field = [3, n0, _F, 0, [_n, _ty], [0, 0]];
export var FileLocation = [3, n0, _FL, 0, [_str, _sL], [() => _Stream, () => S3Location]];
export var FirehoseAction = [3, n0, _FA, 0, [_rA, _dSN, _sep, _bM], [0, 0, 0, 2]];
export var FleetMetricNameAndArn = [3, n0, _FMNAA, 0, [_mNe, _mA], [0, 0]];
export var GeoLocationTarget = [3, n0, _GLT, 0, [_n, _or], [0, 0]];
...
export var GetBucketsAggregationResponse = [3, n0, _GBARe, 0, [_tCo, _bu], [1, () => Buckets]];
export var GetCardinalityRequest = [3, n0, _GCR, 0, [_iN, _qS, _aF, _qV], [0, 0, 0, 0]];
export var GetCardinalityResponse = [3, n0, _GCRe, 0, [_ca], [1]];
export var GetCommandExecutionRequest = [
    3,
    n0,
    _GCER,
    0,
...
export var GetCommandExecutionResponse = [
    3,
    n0,
    _GCERe,
    0,
...
export var GetCommandRequest = [3, n0, _GCRet, 0, [_cIo], [[0, 1]]];
export var GetCommandResponse = [
    3,
    n0,
    _GCReto,
    0,
...
export var GetEffectivePoliciesResponse = [3, n0, _GEPRe, 0, [_eP], [() => EffectivePolicies]];
export var GetIndexingConfigurationRequest = [3, n0, _GICR, 0, [], []];
...
export var GetJobDocumentResponse = [3, n0, _GJDRe, 0, [_do], [0]];
export var GetLoggingOptionsRequest = [3, n0, _GLOR, 0, [], []];
export var GetLoggingOptionsResponse = [3, n0, _GLORe, 0, [_rA, _lL], [0, 0]];
export var GetOTAUpdateRequest = [3, n0, _GOTAUR, 0, [_oUI], [[0, 1]]];
export var GetOTAUpdateResponse = [3, n0, _GOTAURe, 0, [_oUIt], [() => OTAUpdateInfo]];
export var GetPackageConfigurationRequest = [3, n0, _GPCR, 0, [], []];
export var GetPackageConfigurationResponse = [
    3,
    n0,
    _GPCRe,
    0,
...
export var GetPackageRequest = [3, n0, _GPR, 0, [_pN], [[0, 1]]];
export var GetPackageResponse = [
    3,
    n0,
    _GPRe,
    0,
...
export var GetPackageVersionRequest = [
    3,
    n0,
    _GPVR,
    0,
...
export var GetPackageVersionResponse = [
    3,
    n0,
    _GPVRe,
    0,
...
export var GetPercentilesResponse = [3, n0, _GPRete, 0, [_perc], [() => Percentiles]];
export var GetPolicyRequest = [3, n0, _GPReto, 0, [_pNo], [[0, 1]]];
export var GetPolicyResponse = [
    3,
    n0,
    _GPRetol,
    0,
    [_pNo, _pAo, _pDo, _dVI, _cD, _lMD, _gI],
    [0, 0, 0, 0, 4, 4, 0],
];
...
export var GetRegistrationCodeRequest = [3, n0, _GRCR, 0, [], []];
export var GetRegistrationCodeResponse = [3, n0, _GRCRe, 0, [_rCeg], [0]];
export var GetStatisticsRequest = [3, n0, _GSR, 0, [_iN, _qS, _aF, _qV], [0, 0, 0, 0]];
export var GetStatisticsResponse = [3, n0, _GSRe, 0, [_sta], [() => Statistics]];
export var GetThingConnectivityDataRequest = [
    3,
    n0,
    _GTCDR,
    0,
...
export var GetThingConnectivityDataResponse = [
    3,
    n0,
    _GTCDRe,
    0,
...
export var GetTopicRuleDestinationRequest = [3, n0, _GTRDR, 0, [_ar], [[0, 1]]];
...
export var HttpContext = [3, n0, _HC, 0, [_he, _qS], [128 | 0, 0]];
export var HttpUrlDestinationConfiguration = [3, n0, _HUDC, 0, [_cU], [0]];
export var HttpUrlDestinationProperties = [3, n0, _HUDP, 0, [_cU], [0]];
export var HttpUrlDestinationSummary = [3, n0, _HUDS, 0, [_cU], [0]];
export var ImplicitDeny = [3, n0, _ID, 0, [_p], [() => Policies]];
export var IndexingFilter = [3, n0, _IF, 0, [_nSN, _gL], [64 | 0, () => GeoLocationsFilter]];
export var IndexNotReadyException = [
    -3,
    n0,
    _INRE,
    {
...
export var InvalidAggregationException = [
    -3,
    n0,
    _IAE,
    {
...
export var InvalidResponseException = [
    -3,
    n0,
    _IREn,
    {
...
export var IotAnalyticsAction = [3, n0, _IAA, 0, [_cAh, _cNh, _bM, _rA], [0, 0, 2, 0]];
export var IotEventsAction = [3, n0, _IEA, 0, [_iNn, _mI, _bM, _rA], [0, 0, 2, 0]];
...
export var IssuerCertificateIdentifier = [3, n0, _ICI, 0, [_iCS, _iI, _iCSN], [0, 0, 0]];
export var Job = [
    3,
    n0,
    _J,
...
export var JobExecutionsRetryConfig = [3, n0, _JERC, 0, [_cL], [() => RetryCriteriaList]];
export var JobExecutionsRolloutConfig = [
    ...
    0,
    [_mPM, _eR],
    [1, () => ExponentialRolloutRate],
];
export var JobExecutionStatusDetails = [3, n0, _JESD, 0, [_dM], [128 | 0]];
export var JobExecutionSummary = [
    3,
    n0,
    _JES,
    0,
    [_st, _qA, _sAt, _lUA, _eN, _rAe],
    [0, 4, 4, 4, 1, 1],
];
export var JobExecutionSummaryForJob = [
    3,
    n0,
    _JESFJ,
    0,
...
export var JobExecutionSummaryForThing = [
    3,
    n0,
    _JESFT,
    0,
...
export var JobTemplateSummary = [3, n0, _JTS, 0, [_jTA, _jTI, _d, _cAr], [0, 0, 0, 4]];
...
export var KafkaActionHeader = [3, n0, _KAH, 0, [_ke, _va], [0, 0]];
export var KeyPair = [3, n0, _KP, 0, [_PKu, _PK], [0, [() => PrivateKey, 0]]];
export var KinesisAction = [3, n0, _KAi, 0, [_rA, _sN, _pK], [0, 0, 0]];
export var LambdaAction = [3, n0, _LA, 0, [_fA], [0]];
...
export var ListAttachedPoliciesResponse = [3, n0, _LAPRi, 0, [_p, _nM], [() => Policies, 0]];
...
export var ListAuditTasksResponse = [
    ...
    0,
    [_tas, _nT],
    [() => AuditTaskMetadataList, 0],
];
export var ListAuthorizersRequest = [
    3,
    n0,
    _LAR,
    0,
...
export var ListAuthorizersResponse = [3, n0, _LARi, 0, [_aut, _nM], [() => Authorizers, 0]];
export var ListBillingGroupsRequest = [
    3,
    n0,
    _LBGR,
    0,
...
export var ListBillingGroupsResponse = [
    3,
    n0,
    _LBGRi,
    0,
    [_bG, _nT],
    [() => BillingGroupNameAndArnList, 0],
];
export var ListCACertificatesRequest = [
    3,
    n0,
    _LCACR,
    0,
...
export var ListCACertificatesResponse = [
    3,
    n0,
    _LCACRi,
    0,
...
export var ListCertificateProvidersRequest = [
    3,
    n0,
    _LCPR,
    0,
...
export var ListCertificateProvidersResponse = [
    3,
    n0,
    _LCPRi,
    0,
...
export var ListCertificatesByCARequest = [
    3,
    n0,
    _LCBCAR,
    0,
...
export var ListCertificatesByCAResponse = [
    3,
    n0,
    _LCBCARi,
    0,
...
export var ListCertificatesResponse = [3, n0, _LCRi, 0, [_ce, _nM], [() => Certificates, 0]];
export var ListCommandExecutionsRequest = [
    3,
    n0,
    _LCER,
    0,
...
export var ListCommandExecutionsResponse = [
    3,
    n0,
    _LCERi,
    0,
    [_cE, _nT],
    [() => CommandExecutionSummaryList, 0],
];
...
export var ListCommandsResponse = [
    3,
    n0,
    _LCRist,
    0,
    [_com, _nT],
    [() => CommandSummaryList, 0],
];
export var ListCustomMetricsRequest = [
    3,
    n0,
    _LCMR,
    0,
...
export var ListCustomMetricsResponse = [3, n0, _LCMRi, 0, [_mNet, _nT], [64 | 0, 0]];
export var ListDetectMitigationActionsExecutionsRequest = [
    3,
    n0,
    _LDMAER,
    0,
...
export var ListDetectMitigationActionsExecutionsResponse = [
    3,
    n0,
    _LDMAERi,
    0,
...
export var ListDetectMitigationActionsTasksRequest = [
    3,
    n0,
    _LDMATR,
    0,
...
export var ListDetectMitigationActionsTasksResponse = [
    3,
    n0,
    _LDMATRi,
    0,
...
export var ListDimensionsRequest = [
    3,
    n0,
    _LDR,
    0,
...
export var ListDimensionsResponse = [3, n0, _LDRi, 0, [_dNi, _nT], [64 | 0, 0]];
export var ListDomainConfigurationsRequest = [
    3,
    n0,
    _LDCR,
    0,
...
export var ListDomainConfigurationsResponse = [
    3,
    n0,
    _LDCRi,
    0,
    [_dCo, _nM],
    [() => DomainConfigurations, 0],
];
export var ListFleetMetricsRequest = [
    3,
    n0,
    _LFMR,
    0,
...
export var ListFleetMetricsResponse = [
    3,
    n0,
    _LFMRi,
    0,
    [_fM, _nT],
    [() => FleetMetricNameAndArnList, 0],
];
...
export var ListIndicesResponse = [3, n0, _LIRi, 0, [_iNnd, _nT], [64 | 0, 0]];
export var ListJobExecutionsForJobRequest = [
    3,
    n0,
    _LJEFJR,
    0,
...
export var ListJobExecutionsForJobResponse = [
    3,
    n0,
    _LJEFJRi,
    0,
...
export var ListJobExecutionsForThingRequest = [
    3,
    n0,
    _LJEFTR,
    0,
...
export var ListJobExecutionsForThingResponse = [
    3,
    n0,
    _LJEFTRi,
    0,
...
export var ListJobsResponse = [3, n0, _LJRi, 0, [_jo, _nT], [() => JobSummaryList, 0]];
...
export var ListJobTemplatesResponse = [
    ...
    0,
    [_jT, _nT],
    [() => JobTemplateSummaryList, 0],
];
export var ListManagedJobTemplatesRequest = [
    3,
    n0,
    _LMJTR,
    0,
...
export var ListManagedJobTemplatesResponse = [
    3,
    n0,
    _LMJTRi,
    0,
...
export var ListMetricValuesRequest = [
    3,
    n0,
    _LMVR,
    0,
...
export var ListMetricValuesResponse = [
    3,
    n0,
    _LMVRi,
    0,
...
export var ListMitigationActionsRequest = [
    3,
    n0,
    _LMAR,
    0,
...
export var ListMitigationActionsResponse = [
    3,
    n0,
    _LMARi,
    0,
...
export var ListOTAUpdatesRequest = [
    3,
    n0,
    _LOTAUR,
    0,
...
export var ListOTAUpdatesResponse = [
    3,
    n0,
    _LOTAURi,
    0,
...
export var ListOutgoingCertificatesRequest = [
    3,
    n0,
    _LOCR,
    0,
...
export var ListOutgoingCertificatesResponse = [
    3,
    n0,
    _LOCRi,
    0,
    [_oC, _nM],
    [() => OutgoingCertificates, 0],
];
...
export var ListPackagesResponse = [3, n0, _LPRi, 0, [_pSa, _nT], [() => PackageSummaryList, 0]];
...
export var ListPackageVersionsResponse = [
    3,
    n0,
    _LPVRi,
    0,
    [_pVS, _nT],
    [() => PackageVersionSummaryList, 0],
];
...
export var ListPoliciesResponse = [3, n0, _LPRist, 0, [_p, _nM], [() => Policies, 0]];
export var ListPolicyPrincipalsRequest = [
    3,
    n0,
    _LPPR,
    0,
...
export var ListPolicyPrincipalsResponse = [3, n0, _LPPRi, 0, [_pri, _nM], [64 | 0, 0]];
export var ListPolicyVersionsRequest = [3, n0, _LPVRis, 0, [_pNo], [[0, 1]]];
export var ListPolicyVersionsResponse = [3, n0, _LPVRist, 0, [_pV], [() => PolicyVersions]];
export var ListPrincipalPoliciesRequest = [
    3,
    n0,
    _LPPRis,
    0,
...
export var ListPrincipalPoliciesResponse = [3, n0, _LPPRist, 0, [_p, _nM], [() => Policies, 0]];
export var ListPrincipalThingsRequest = [
    3,
    n0,
    _LPTR,
    0,
...
export var ListPrincipalThingsResponse = [3, n0, _LPTRi, 0, [_th, _nT], [64 | 0, 0]];
export var ListPrincipalThingsV2Request = [
    3,
    n0,
    _LPTVR,
    0,
...
export var ListPrincipalThingsV2Response = [
    3,
    n0,
    _LPTVRi,
    0,
    [_pTO, _nT],
    [() => PrincipalThingObjects, 0],
];
export var ListProvisioningTemplatesRequest = [
    3,
    n0,
    _LPTRis,
    0,
...
export var ListProvisioningTemplatesResponse = [
    3,
    n0,
    _LPTRist,
    0,
...
export var ListProvisioningTemplateVersionsRequest = [
    3,
    n0,
    _LPTVRis,
    0,
...
export var ListProvisioningTemplateVersionsResponse = [
    3,
    n0,
    _LPTVRist,
    0,
...
export var ListRelatedResourcesForAuditFindingResponse = [
    3,
    n0,
    _LRRFAFRi,
    0,
...
export var ListRoleAliasesRequest = [
    3,
    n0,
    _LRAR,
    0,
...
export var ListRoleAliasesResponse = [3, n0, _LRARi, 0, [_rAol, _nM], [64 | 0, 0]];
export var ListSbomValidationResultsRequest = [
    3,
    n0,
    _LSVRR,
    0,
...
export var ListSbomValidationResultsResponse = [
    3,
    n0,
    _LSVRRi,
    0,
...
export var ListScheduledAuditsRequest = [
    3,
    n0,
    _LSAR,
    0,
...
export var ListScheduledAuditsResponse = [
    3,
    n0,
    _LSARi,
    0,
    [_sAc, _nT],
    [() => ScheduledAuditMetadataList, 0],
];
export var ListSecurityProfilesForTargetRequest = [
    3,
    n0,
    _LSPFTR,
    0,
...
export var ListSecurityProfilesForTargetResponse = [
    3,
    n0,
    _LSPFTRi,
    0,
...
export var ListStreamsResponse = [3, n0, _LSRi, 0, [_stre, _nT], [() => StreamsSummary, 0]];
...
export var ListTagsForResourceResponse = [3, n0, _LTFRRi, 0, [_tag, _nT], [() => TagList, 0]];
...
export var ListTargetsForPolicyResponse = [3, n0, _LTFPRi, 0, [_ta, _nM], [64 | 0, 0]];
export var ListTargetsForSecurityProfileRequest = [
    3,
    n0,
    _LTFSPR,
    0,
...
export var ListTargetsForSecurityProfileResponse = [
    3,
    n0,
    _LTFSPRi,
    0,
...
export var ListThingGroupsForThingRequest = [
    3,
    n0,
    _LTGFTR,
    0,
...
export var ListThingGroupsForThingResponse = [
    3,
    n0,
    _LTGFTRi,
    0,
    [_tG, _nT],
    [() => ThingGroupNameAndArnList, 0],
];
export var ListThingGroupsRequest = [
    3,
    n0,
    _LTGR,
    0,
...
export var ListThingGroupsResponse = [
    3,
    n0,
    _LTGRi,
    0,
...
export var ListThingPrincipalsRequest = [
    3,
    n0,
    _LTPR,
    0,
...
export var ListThingPrincipalsResponse = [3, n0, _LTPRi, 0, [_pri, _nT], [64 | 0, 0]];
export var ListThingPrincipalsV2Request = [
    3,
    n0,
    _LTPVR,
    0,
...
export var ListThingPrincipalsV2Response = [
    3,
    n0,
    _LTPVRi,
    0,
    [_tPO, _nT],
    [() => ThingPrincipalObjects, 0],
];
...
export var ListThingRegistrationTasksResponse = [3, n0, _LTRTRi, 0, [_tIa, _nT], [64 | 0, 0]];
...
export var ListThingsInBillingGroupResponse = [3, n0, _LTIBGRi, 0, [_th, _nT], [64 | 0, 0]];
...
export var ListThingsInThingGroupResponse = [3, n0, _LTITGRi, 0, [_th, _nT], [64 | 0, 0]];
...
export var ListThingsResponse = [3, n0, _LTRi, 0, [_th, _nT], [() => ThingAttributeList, 0]];
...
export var ListThingTypesResponse = [3, n0, _LTTRi, 0, [_tTh, _nT], [() => ThingTypeList, 0]];
...
export var ListTopicRulesResponse = [3, n0, _LTRRi, 0, [_rul, _nT], [() => TopicRuleList, 0]];
...
export var MachineLearningDetectionConfig = [3, n0, _MLDC, 0, [_cLo], [0]];
export var MaintenanceWindow = [3, n0, _MW, 0, [_sT, _dIM], [0, 1]];
...
export var ManagedJobTemplateSummary = [
    3,
    n0,
    _MJTS,
    0,
...
export var MetricDatum = [3, n0, _MD, 0, [_ti, _va], [4, () => MetricValue]];
export var MetricDimension = [3, n0, _MDe, 0, [_dNim, _ope], [0, 0]];
export var MetricsExportConfig = [3, n0, _MEC, 0, [_mTq, _rA], [0, 0]];
export var MetricToRetain = [3, n0, _MTR, 0, [_met, _mD, _eM], [0, () => MetricDimension, 2]];
export var MetricValue = [
    3,
    n0,
    _MV,
    0,
    [_cou, _ci, _po, _nu, _num, _stri],
    [1, 64 | 0, 64 | 1, 1, 64 | 1, 64 | 0],
];
...
export var MitigationActionIdentifier = [3, n0, _MAI, 0, [_aN, _aAc, _cD], [0, 0, 4]];
...
export var Mqtt5Configuration = [3, n0, _MC, 0, [_pAr], [() => PropagatingAttributeList]];
export var MqttContext = [3, n0, _MCq, 0, [_us, _pas, _cIl], [0, 21, 0]];
export var MqttHeaders = [
    3,
    n0,
    _MH,
    0,
    [_pFI, _cTo, _rTe, _cDor, _mE, _uP],
    [0, 0, 0, 0, 0, () => UserProperties],
];
...
export var NotConfiguredException = [
    -3,
    n0,
    _NCE,
    {
...
export var OpenSearchAction = [3, n0, _OSA, 0, [_rA, _end, _i, _ty, _id], [0, 0, 0, 0, 0]];
...
export var OTAUpdateSummary = [3, n0, _OTAUS, 0, [_oUI, _oUA, _cD], [0, 0, 4]];
export var OutgoingCertificate = [
    3,
    n0,
    _OC,
    0,
    [_cAe, _cI, _tTr, _tDr, _tM, _cD],
    [0, 0, 0, 4, 0, 4],
];
export var PackageSummary = [3, n0, _PS, 0, [_pN, _dVN, _cD, _lMD], [0, 0, 4, 4]];
export var PackageVersionArtifact = [3, n0, _PVA, 0, [_sL], [() => S3Location]];
export var PackageVersionSummary = [3, n0, _PVS, 0, [_pN, _vN, _st, _cD, _lMD], [0, 0, 0, 4, 4]];
export var PercentPair = [3, n0, _PP, 0, [_perce, _va], [1, 1]];
export var Policy = [3, n0, _P, 0, [_pNo, _pAo], [0, 0]];
export var PolicyVersion = [3, n0, _PV, 0, [_vIe, _iDV, _cDr], [0, 2, 4]];
export var PolicyVersionIdentifier = [3, n0, _PVI, 0, [_pNo, _pVI], [0, 0]];
export var PresignedUrlConfig = [3, n0, _PUC, 0, [_rA, _eIS], [0, 1]];
export var PrincipalThingObject = [3, n0, _PTO, 0, [_tN, _tPT], [0, 0]];
export var PropagatingAttribute = [3, n0, _PA, 0, [_uPK, _tAh, _cAon], [0, 0, 0]];
export var ProvisioningHook = [3, n0, _PH, 0, [_pVa, _tAa], [0, 0]];
export var ProvisioningTemplateSummary = [
    3,
    n0,
    _PTS,
    0,
...
export var ProvisioningTemplateVersionSummary = [3, n0, _PTVS, 0, [_vIe, _cD, _iDV], [1, 4, 2]];
export var PublishFindingToSnsParams = [3, n0, _PFTSP, 0, [_tAo], [0]];
...
export var PutItemInput = [3, n0, _PII, 0, [_tNab], [0]];
...
export var PutVerificationStateOnViolationResponse = [3, n0, _PVSOVRu, 0, [], []];
export var RateIncreaseCriteria = [3, n0, _RIC, 0, [_nONT, _nOST], [1, 1]];
...
export var RegisterCACertificateResponse = [3, n0, _RCACRe, 0, [_cAe, _cI], [0, 0]];
...
export var RegisterCertificateResponse = [3, n0, _RCRe, 0, [_cAe, _cI], [0, 0]];
export var RegisterCertificateWithoutCARequest = [3, n0, _RCWCAR, 0, [_cP, _st], [0, 0]];
export var RegisterCertificateWithoutCAResponse = [3, n0, _RCWCARe, 0, [_cAe, _cI], [0, 0]];
export var RegisterThingRequest = [3, n0, _RTR, 0, [_tB, _par], [0, 128 | 0]];
export var RegisterThingResponse = [3, n0, _RTRe, 0, [_cP, _rAeso], [0, 128 | 0]];
export var RegistrationCodeValidationException = [
    -3,
    n0,
    _RCVE,
    {
...
export var RegistrationConfig = [3, n0, _RC, 0, [_tB, _rA, _tNe], [0, 0, 0]];
export var RejectCertificateTransferRequest = [3, n0, _RCTR, 0, [_cI, _rRe], [[0, 1], 0]];
...
export var RemoveThingFromBillingGroupResponse = [3, n0, _RTFBGRe, 0, [], []];
...
export var RemoveThingFromThingGroupResponse = [3, n0, _RTFTGRe, 0, [], []];
export var ReplaceDefaultPolicyVersionParams = [3, n0, _RDPVP, 0, [_tNe], [0]];
...
export var RepublishAction = [3, n0, _RA, 0, [_rA, _to, _qo, _he], [0, 0, 1, () => MqttHeaders]];
...
export var ResourceRegistrationFailureException = [
    -3,
    n0,
    _RRFE,
    {
...
export var RetryCriteria = [3, n0, _RCe, 0, [_fT, _nOR], [0, 1]];
...
export var S3Action = [3, n0, _SA, 0, [_rA, _bNu, _ke, _cAa], [0, 0, 0, 0]];
export var S3Destination = [3, n0, _SD, 0, [_buc, _pre], [0, 0]];
export var S3Location = [3, n0, _SL, 0, [_buc, _ke, _ve], [0, 0, 0]];
export var SalesforceAction = [3, n0, _SAa, 0, [_tok, _ur], [0, 0]];
export var Sbom = [3, n0, _Sb, 0, [_sL], [() => S3Location]];
export var SbomValidationResultSummary = [3, n0, _SVRS, 0, [_fN, _vR, _eC, _eMr], [0, 0, 0, 0]];
export var ScheduledAuditMetadata = [
    3,
    n0,
    _SAM,
    0,
    [_sAN, _sAAc, _fr, _dOM, _dOW],
    [0, 0, 0, 0, 0],
];
export var ScheduledJobRollout = [3, n0, _SJR, 0, [_sT], [0]];
export var SchedulingConfig = [
    3,
    n0,
    _SC,
    0,
...
export var SecurityProfileIdentifier = [3, n0, _SPI, 0, [_n, _ar], [0, 0]];
export var SecurityProfileTarget = [3, n0, _SPT, 0, [_ar], [0]];
export var SecurityProfileTargetMapping = [
    3,
    n0,
    _SPTM,
    0,
...
export var ServerCertificateConfig = [3, n0, _SCC, 0, [_eOCSPC, _oLA, _oARA], [2, 0, 0]];
export var ServerCertificateSummary = [3, n0, _SCS, 0, [_sCAe, _sCS, _sCSD], [0, 0, 0]];
...
export var SetDefaultAuthorizerRequest = [3, n0, _SDAR, 0, [_aNu], [0]];
export var SetDefaultAuthorizerResponse = [3, n0, _SDARe, 0, [_aNu, _aA], [0, 0]];
...
export var SqsAction = [3, n0, _SAq, 0, [_rA, _qU, _uB], [0, 0, 2]];
...
export var StartAuditMitigationActionsTaskResponse = [3, n0, _SAMATRt, 0, [_tI], [0]];
...
export var StartDetectMitigationActionsTaskResponse = [3, n0, _SDMATRt, 0, [_tI], [0]];
export var StartOnDemandAuditTaskRequest = [3, n0, _SODATR, 0, [_tCN], [64 | 0]];
export var StartOnDemandAuditTaskResponse = [3, n0, _SODATRt, 0, [_tI], [0]];
...
export var StartThingRegistrationTaskResponse = [3, n0, _STRTRt, 0, [_tI], [0]];
export var StatisticalThreshold = [3, n0, _ST, 0, [_stat], [0]];
...
export var StatusReason = [3, n0, _SR, 0, [_rC, _rDe], [0, 0]];
export var StepFunctionsAction = [3, n0, _SFA, 0, [_eNP, _sMN, _rA], [0, 0, 0]];
export var StopThingRegistrationTaskRequest = [3, n0, _STRTRto, 0, [_tI], [[0, 1]]];
export var StopThingRegistrationTaskResponse = [3, n0, _STRTRtop, 0, [], []];
export var _Stream = [3, n0, _Str, 0, [_sIt, _fIil], [0, 1]];
export var StreamFile = [3, n0, _SF, 0, [_fIil, _sL], [1, () => S3Location]];
...
export var StreamSummary = [3, n0, _SS, 0, [_sIt, _sAtr, _sVtr, _d], [0, 0, 1, 0]];
export var Tag = [3, n0, _T, 0, [_K, _V], [0, 0]];
export var TagResourceRequest = [3, n0, _TRR, 0, [_rAes, _tag], [0, () => TagList]];
export var TagResourceResponse = [3, n0, _TRRa, 0, [], []];
export var TaskAlreadyExistsException = [
    -3,
    n0,
    _TAEE,
    {
...
export var TaskStatisticsForAuditCheck = [
    ...
    _TSFAC,
    0,
    [_tFC, _fFC, _sFC, _sFCk, _cFC],
    [1, 1, 1, 1, 1],
];
export var TermsAggregation = [3, n0, _TA, 0, [_mB], [1]];
...
export var TestAuthorizationResponse = [3, n0, _TARe, 0, [_aR], [() => AuthResults]];
...
export var ThingAttribute = [3, n0, _TAh, 0, [_tN, _tTN, _tA, _at, _ve], [0, 0, 0, 128 | 0, 1]];
export var ThingConnectivity = [3, n0, _TC, 0, [_conn, _ti, _dR], [2, 1, 0]];
...
export var ThingGroupMetadata = [
    ...
    0,
    [_pGN, _rTPTG, _cD],
    [0, () => ThingGroupNameAndArnList, 4],
];
export var ThingGroupProperties = [3, n0, _TGP, 0, [_tGD, _aPt], [0, () => AttributePayload]];
...
export var ThingPrincipalObject = [3, n0, _TPO, 0, [_pr, _tPT], [0, 0]];
...
export var ThingTypeMetadata = [3, n0, _TTM, 0, [_dep, _dDe, _cD], [2, 4, 4]];
...
export var TimeFilter = [3, n0, _TF, 0, [_af, _bef], [0, 0]];
export var TimeoutConfig = [3, n0, _TCi, 0, [_iPTIM], [1]];
...
export var TimestreamDimension = [3, n0, _TDi, 0, [_n, _va], [0, 0]];
export var TimestreamTimestamp = [3, n0, _TT, 0, [_va, _u], [0, 0]];
export var TlsConfig = [3, n0, _TCl, 0, [_sP], [0]];
export var TlsContext = [3, n0, _TCls, 0, [_sNer], [0]];
...
export var TopicRuleListItem = [3, n0, _TRLI, 0, [_rAu, _rN, _tPo, _cAr, _rD], [0, 0, 0, 4, 2]];
...
export var TransferCertificateResponse = [3, n0, _TCRr, 0, [_tCA], [0]];
export var TransferConflictException = [
    -3,
    n0,
    _TCE,
    {
...
export var TransferData = [3, n0, _TDr, 0, [_tM, _rRe, _tDr, _aDcc, _rDej], [0, 0, 4, 4, 4]];
...
export var UpdateAccountAuditConfigurationResponse = [3, n0, _UAACRp, 0, [], []];
...
export var UpdateAuditSuppressionResponse = [3, n0, _UASRp, 0, [], []];
...
export var UpdateAuthorizerResponse = [3, n0, _UARp, 0, [_aNu, _aA], [0, 0]];
...
export var UpdateBillingGroupResponse = [3, n0, _UBGRp, 0, [_ve], [1]];
export var UpdateCACertificateParams = [3, n0, _UCACP, 0, [_a], [0]];
...
export var UpdateCertificateProviderRequest = [
    3,
    n0,
    _UCPR,
    0,
...
export var UpdateCertificateProviderResponse = [3, n0, _UCPRp, 0, [_cPN, _cPA], [0, 0]];
...
export var UpdateCommandRequest = [3, n0, _UCRp, 0, [_cIo, _dN, _d, _dep], [[0, 1], 0, 0, 2]];
export var UpdateCommandResponse = [
    3,
    n0,
    _UCRpd,
    0,
    [_cIo, _dN, _d, _dep, _lUA],
    [0, 0, 0, 2, 4],
];
export var UpdateCustomMetricRequest = [3, n0, _UCMR, 0, [_mNe, _dN], [[0, 1], 0]];
...
export var UpdateDeviceCertificateParams = [3, n0, _UDCP, 0, [_a], [0]];
export var UpdateDimensionRequest = [3, n0, _UDR, 0, [_n, _sVt], [[0, 1], 64 | 0]];
...
export var UpdateDomainConfigurationResponse = [3, n0, _UDCRp, 0, [_dCN, _dCA], [0, 0]];
...
export var UpdateDynamicThingGroupResponse = [3, n0, _UDTGRp, 0, [_ve], [1]];
export var UpdateEncryptionConfigurationRequest = [
    3,
    n0,
    _UECR,
    0,
...
export var UpdateEncryptionConfigurationResponse = [3, n0, _UECRp, 0, [], []];
...
export var UpdateEventConfigurationsResponse = [3, n0, _UECRpda, 0, [], []];
...
export var UpdateIndexingConfigurationResponse = [3, n0, _UICRp, 0, [], []];
...
export var UpdateMitigationActionResponse = [3, n0, _UMARp, 0, [_aAc, _aI], [0, 0]];
export var UpdatePackageConfigurationRequest = [
    3,
    n0,
    _UPCR,
    0,
...
export var UpdateProvisioningTemplateResponse = [3, n0, _UPTRp, 0, [], []];
export var UpdateRoleAliasRequest = [3, n0, _URAR, 0, [_rAo, _rA, _cDS], [[0, 1], 0, 1]];
export var UpdateRoleAliasResponse = [3, n0, _URARp, 0, [_rAo, _rAA], [0, 0]];
...
export var UpdateScheduledAuditResponse = [3, n0, _USARp, 0, [_sAAc], [0]];
...
export var UpdateStreamResponse = [3, n0, _USRp, 0, [_sIt, _sAtr, _d, _sVtr], [0, 0, 0, 1]];
...
export var UpdateThingGroupResponse = [3, n0, _UTGRp, 0, [_ve], [1]];
export var UpdateThingGroupsForThingRequest = [
    3,
    n0,
    _UTGFTR,
    0,
    [_tN, _tGTA, _tGTR, _oDG],
    [0, 64 | 0, 64 | 0, 2],
];
export var UpdateThingGroupsForThingResponse = [3, n0, _UTGFTRp, 0, [], []];
...
export var UpdateThingResponse = [3, n0, _UTRp, 0, [], []];
export var UpdateThingTypeRequest = [
    3,
    n0,
    _UTTR,
    0,
...
export var UpdateThingTypeResponse = [3, n0, _UTTRp, 0, [], []];
export var UpdateTopicRuleDestinationRequest = [3, n0, _UTRDR, 0, [_ar, _st], [0, 0]];
export var UpdateTopicRuleDestinationResponse = [3, n0, _UTRDRp, 0, [], []];
export var UserProperty = [3, n0, _UP, 0, [_ke, _va], [0, 0]];
...
export var ValidationError = [3, n0, _VE, 0, [_eMr], [0]];
...
export var VersionUpdateByJobsConfig = [3, n0, _VUBJC, 0, [_en, _rA], [2, 0]];
...
export var ViolationEventAdditionalInfo = [3, n0, _VEAI, 0, [_cLo], [0]];
export var ViolationEventOccurrenceRange = [3, n0, _VEOR, 0, [_sT, _eT], [4, 4]];
...
export var IoTServiceException = [-3, _sm, "IoTServiceException", 0, [], []];
TypeRegistry.for(_sm).registerError(IoTServiceException, __IoTServiceException);
export var AbortCriteriaList = [1, n0, _ACL, 0, () => AbortCriteria];
export var ActionList = [1, n0, _AL, 0, () => Action];
export var ActiveViolations = [1, n0, _AVc, 0, () => ActiveViolation];
export var AdditionalMetricsToRetainList = 64 | 0;
export var AdditionalMetricsToRetainV2List = [1, n0, _AMTRVL, 0, () => MetricToRetain];
export var AggregationTypeValues = 64 | 0;
export var AssetPropertyValueList = [1, n0, _APVL, 0, () => AssetPropertyValue];
export var AuditFindings = [1, n0, _AFu, 0, () => AuditFinding];
export var AuditMitigationActionExecutionMetadataList = [
    1,
    n0,
    _AMAEML,
    0,
...
export var AuditMitigationActionsTaskMetadataList = [
    1,
    n0,
    _AMATML,
    0,
...
export var AuditSuppressionList = [1, n0, _ASL, 0, () => AuditSuppression];
export var AuditTaskMetadataList = [1, n0, _ATML, 0, () => AuditTaskMetadata];
export var AuthInfos = [1, n0, _AIu, 0, () => AuthInfo];
export var Authorizers = [1, n0, _Au, 0, () => AuthorizerSummary];
export var AuthResults = [1, n0, _ARu, 0, () => AuthResult];
export var AwsJobAbortCriteriaList = [1, n0, _AJACL, 0, () => AwsJobAbortCriteria];
export var BehaviorModelTrainingSummaries = [1, n0, _BMTSe, 0, () => BehaviorModelTrainingSummary];
export var Behaviors = [1, n0, _Be, 0, () => Behavior];
export var BillingGroupNameAndArnList = [1, n0, _BGNAAL, 0, () => GroupNameAndArn];
export var Buckets = [1, n0, _Buc, 0, () => Bucket];
export var CACertificates = [1, n0, _CACe, 0, () => CACertificate];
export var CertificateProviderAccountDefaultForOperations = 64 | 0;
export var CertificateProviders = [1, n0, _CPe, 0, () => CertificateProviderSummary];
export var Certificates = [1, n0, _Ce, 0, () => Certificate];
export var Cidrs = 64 | 0;
export var CommandExecutionSummaryList = [1, n0, _CESL, 0, () => CommandExecutionSummary];
export var CommandParameterList = [1, n0, _CPL, 0, () => CommandParameter];
export var CommandSummaryList = [1, n0, _CSL, 0, () => CommandSummary];
export var DestinationPackageVersions = 64 | 0;
export var DetectMitigationActionExecutionList = [
    1,
    n0,
    _DMAEL,
    0,
...
export var DetectMitigationActionsTaskSummaryList = [
    1,
    n0,
    _DMATSL,
    0,
...
export var DocumentParameters = [1, n0, _DPo, 0, () => DocumentParameter];
export var DomainConfigurations = [1, n0, _DC, 0, () => DomainConfigurationSummary];
export var EffectivePolicies = [1, n0, _EPf, 0, () => EffectivePolicy];
export var Environments = 64 | 0;
export var Fields = [1, n0, _Fi, 0, () => Field];
export var FindingIds = 64 | 0;
export var FleetMetricNameAndArnList = [1, n0, _FMNAAL, 0, () => FleetMetricNameAndArn];
export var GeoLocationsFilter = [1, n0, _GLF, 0, () => GeoLocationTarget];
export var HeaderList = [1, n0, _HL, 0, () => HttpActionHeader];
export var IndexNamesList = 64 | 0;
export var JobExecutionSummaryForJobList = [1, n0, _JESFJL, 0, () => JobExecutionSummaryForJob];
export var JobExecutionSummaryForThingList = [1, n0, _JESFTL, 0, () => JobExecutionSummaryForThing];
export var JobSummaryList = [1, n0, _JSL, 0, () => JobSummary];
export var JobTargets = 64 | 0;
export var JobTemplateSummaryList = [1, n0, _JTSL, 0, () => JobTemplateSummary];
export var KafkaHeaders = [1, n0, _KH, 0, () => KafkaActionHeader];
export var LogTargetConfigurations = [1, n0, _LTCo, 0, () => LogTargetConfiguration];
export var MaintenanceWindows = [1, n0, _MWa, 0, () => MaintenanceWindow];
export var ManagedJobTemplatesSummaryList = [1, n0, _MJTSL, 0, () => ManagedJobTemplateSummary];
export var MetricDatumList = [1, n0, _MDL, 0, () => MetricDatum];
export var MetricNames = 64 | 0;
export var MissingContextValues = 64 | 0;
export var MitigationActionIdentifierList = [1, n0, _MAIL, 0, () => MitigationActionIdentifier];
export var MitigationActionList = [1, n0, _MAL, 0, () => MitigationAction];
export var MitigationActionNameList = 64 | 0;
export var NamedShadowNamesFilter = 64 | 0;
export var NumberList = 64 | 1;
export var OTAUpdateFiles = [1, n0, _OTAUFp, 0, () => OTAUpdateFile];
export var OTAUpdatesSummary = [1, n0, _OTAUSp, 0, () => OTAUpdateSummary];
export var OutgoingCertificates = [1, n0, _OCu, 0, () => OutgoingCertificate];
...
export var Percentiles = [1, n0, _Pe, 0, () => PercentPair];
export var PercentList = 64 | 1;
export var Policies = [1, n0, _Po, 0, () => Policy];
export var PolicyDocuments = 64 | 0;
export var PolicyNames = 64 | 0;
export var PolicyTargets = 64 | 0;
export var PolicyVersions = [1, n0, _PVo, 0, () => PolicyVersion];
export var Ports = 64 | 1;
export var Principals = 64 | 0;
export var PrincipalThingObjects = [1, n0, _PTOr, 0, () => PrincipalThingObject];
export var ProcessingTargetNameList = 64 | 0;
export var PropagatingAttributeList = [1, n0, _PAL, 0, () => PropagatingAttribute];
export var Protocols = 64 | 0;
export var ProvisioningTemplateListing = [1, n0, _PTL, 0, () => ProvisioningTemplateSummary];
export var ProvisioningTemplateVersionListing = [
    1,
    n0,
    _PTVL,
    0,
...
export var PutAssetPropertyValueEntryList = [1, n0, _PAPVEL, 0, () => PutAssetPropertyValueEntry];
export var ReasonForNonComplianceCodes = 64 | 0;
export var RelatedResources = [1, n0, _RRe, 0, () => RelatedResource];
export var Resources = 64 | 0;
export var RetryCriteriaList = [1, n0, _RCL, 0, () => RetryCriteria];
export var RoleAliases = 64 | 0;
export var S3FileUrlList = 64 | 0;
export var SbomValidationResultSummaryList = [1, n0, _SVRSL, 0, () => SbomValidationResultSummary];
export var ScheduledAuditMetadataList = [1, n0, _SAML, 0, () => ScheduledAuditMetadata];
export var ScheduledJobRolloutList = [1, n0, _SJRL, 0, () => ScheduledJobRollout];
export var SearchableAttributes = 64 | 0;
export var SecurityGroupList = 64 | 0;
export var SecurityProfileIdentifiers = [1, n0, _SPIe, 0, () => SecurityProfileIdentifier];
export var SecurityProfileTargetMappings = [1, n0, _SPTMe, 0, () => SecurityProfileTargetMapping];
export var SecurityProfileTargets = [1, n0, _SPTe, 0, () => SecurityProfileTarget];
export var ServerCertificateArns = 64 | 0;
export var ServerCertificates = [1, n0, _SCe, 0, () => ServerCertificateSummary];
export var StreamFiles = [1, n0, _SFt, 0, () => StreamFile];
export var StreamsSummary = [1, n0, _SSt, 0, () => StreamSummary];
...
export var ThingAttributeList = [1, n0, _TAL, 0, () => ThingAttribute];
export var ThingDocumentList = [1, n0, _TDL, 0, () => ThingDocument];
export var ThingGroupDocumentList = [1, n0, _TGDL, 0, () => ThingGroupDocument];
export var ThingGroupList = 64 | 0;
export var ThingGroupNameAndArnList = [1, n0, _TGNAAL, 0, () => GroupNameAndArn];
export var ThingGroupNameList = 64 | 0;
export var ThingGroupNames = 64 | 0;
export var ThingNameList = 64 | 0;
export var ThingPrincipalObjects = [1, n0, _TPOh, 0, () => ThingPrincipalObject];
export var ThingTypeList = [1, n0, _TTL, 0, () => ThingTypeDefinition];
export var TimestreamDimensionList = [1, n0, _TDLi, 0, () => TimestreamDimension];
export var TopicRuleDestinationSummaries = [1, n0, _TRDSo, 0, () => TopicRuleDestinationSummary];
export var TopicRuleList = [1, n0, _TRL, 0, () => TopicRuleListItem];
export var UserProperties = [1, n0, _UPs, 0, () => UserProperty];
export var ValidationErrors = [1, n0, _VEal, 0, () => ValidationError];
export var ViolationEvents = [1, n0, _VEio, 0, () => ViolationEvent];
export var AdditionalParameterMap = 128 | 0;
export var AlertTargets = [2, n0, _ATle, 0, 0, () => AlertTarget];
export var Attributes = 128 | 0;
export var AttributesMap = 128 | 0;
export var AuditCheckConfigurations = [2, n0, _ACCu, 0, 0, () => AuditCheckConfiguration];
export var AuditCheckToActionsMapping = [2, n0, _ACTAM, 0, 0, 64 | 0];
export var AuditCheckToReasonCodeFilter = [2, n0, _ACTRCF, 0, 0, 64 | 0];
export var AuditDetails = [2, n0, _ADu, 0, 0, () => AuditCheckDetails];
export var AuditMitigationActionsTaskStatistics = [
    2,
    n0,
    _AMATS,
    0,
...
export var AuditNotificationTargetConfigurations = [2, n0, _ANTC, 0, 0, () => AuditNotificationTarget];
...
export var CommandExecutionResultMap = [2, n0, _CERM, 0, 0, () => CommandExecutionResult];
export var DetailsMap = 128 | 0;
export var EventConfigurations = [2, n0, _EC, 0, 0, () => Configuration];
...
export var ResourceAttributes = [2, n0, _RAe, 8, 0, 0];
...
export var AddThingToBillingGroup = [
    9,
    n0,
    _ATTBG,
    {
...
export var AddThingToThingGroup = [
    9,
    n0,
    _ATTTG,
    {
...
export var AssociateSbomWithPackageVersion = [
    9,
    n0,
    _ASWPV,
    {
...
export var AssociateTargetsWithJob = [
    9,
    n0,
    _ATWJ,
    {
...
export var AttachPrincipalPolicy = [
    9,
    n0,
    _APP,
    {
...
export var AttachSecurityProfile = [
    9,
    n0,
    _ASP,
    {
...
export var AttachThingPrincipal = [
    9,
    n0,
    _ATP,
    {
...
export var CancelAuditMitigationActionsTask = [
    9,
    n0,
    _CAMAT,
    {
...
export var CancelCertificateTransfer = [
    9,
    n0,
    _CCT,
    {
...
export var CancelDetectMitigationActionsTask = [
    9,
    n0,
    _CDMAT,
    {
...
export var ClearDefaultAuthorizer = [
    9,
    n0,
    _CDA,
    {
...
export var ConfirmTopicRuleDestination = [
    9,
    n0,
    _CTRD,
    {
...
export var CreateAuditSuppression = [
    9,
    n0,
    _CAS,
    {
...
export var CreateCertificateFromCsr = [
    9,
    n0,
    _CCFC,
    {
...
export var CreateCertificateProvider = [
    9,
    n0,
    _CCP,
    {
...
export var CreateDomainConfiguration = [
    9,
    n0,
    _CDC,
    {
...
export var CreateDynamicThingGroup = [
    9,
    n0,
    _CDTG,
    {
...
export var CreateKeysAndCertificate = [
    9,
    n0,
    _CKAC,
    {
...
export var CreateMitigationAction = [
    9,
    n0,
    _CMAr,
    {
...
export var CreatePackageVersion = [
    9,
    n0,
    _CPVr,
    {
...
export var CreateProvisioningClaim = [
    9,
    n0,
    _CPC,
    {
...
export var CreateProvisioningTemplate = [
    9,
    n0,
    _CPT,
    {
...
export var CreateProvisioningTemplateVersion = [
    9,
    n0,
    _CPTV,
    {
...
export var CreateScheduledAudit = [
    9,
    n0,
    _CSA,
    {
...
export var CreateSecurityProfile = [
    9,
    n0,
    _CSP,
    {
...
export var CreateTopicRuleDestination = [
    9,
    n0,
    _CTRDr,
    {
...
export var DeleteAccountAuditConfiguration = [
    9,
    n0,
    _DAAC,
    {
...
export var DeleteAuditSuppression = [
    9,
    n0,
    _DAS,
    {
...
export var DeleteCACertificate = [
    9,
    n0,
    _DCAC,
    {
...
export var DeleteCertificateProvider = [
    9,
    n0,
    _DCP,
    {
...
export var DeleteCommandExecution = [
    9,
    n0,
    _DCEe,
    {
...
export var DeleteDomainConfiguration = [
    9,
    n0,
    _DDC,
    {
...
export var DeleteDynamicThingGroup = [
    9,
    n0,
    _DDTG,
    {
...
export var DeleteMitigationAction = [
    9,
    n0,
    _DMA,
    {
...
export var DeletePackageVersion = [
    9,
    n0,
    _DPV,
    {
...
export var DeleteProvisioningTemplate = [
    9,
    n0,
    _DPT,
    {
...
export var DeleteProvisioningTemplateVersion = [
    9,
    n0,
    _DPTV,
    {
...
export var DeleteRegistrationCode = [
    9,
    n0,
    _DRC,
    {
...
export var DeleteScheduledAudit = [
    9,
    n0,
    _DSA,
    {
...
export var DeleteSecurityProfile = [
    9,
    n0,
    _DSP,
    {
...
export var DeleteTopicRuleDestination = [
    9,
    n0,
    _DTRD,
    {
...
export var DeleteV2LoggingLevel = [
    9,
    n0,
    _DVLL,
    {
...
export var DescribeAccountAuditConfiguration = [
    9,
    n0,
    _DAACe,
    {
...
export var DescribeAuditFinding = [
    9,
    n0,
    _DAF,
    {
...
export var DescribeAuditMitigationActionsTask = [
    9,
    n0,
    _DAMAT,
    {
...
export var DescribeAuditSuppression = [
    9,
    n0,
    _DASe,
    {
...
export var DescribeBillingGroup = [
    9,
    n0,
    _DBGe,
    {
...
export var DescribeCACertificate = [
    9,
    n0,
    _DCACe,
    {
...
export var DescribeCertificateProvider = [
    9,
    n0,
    _DCPe,
    {
...
export var DescribeCustomMetric = [
    9,
    n0,
    _DCMe,
    {
...
export var DescribeDefaultAuthorizer = [
    9,
    n0,
    _DDA,
    {
...
export var DescribeDetectMitigationActionsTask = [
    9,
    n0,
    _DDMAT,
    {
...
export var DescribeDomainConfiguration = [
    9,
    n0,
    _DDCe,
    {
...
export var DescribeEncryptionConfiguration = [
    9,
    n0,
    _DEC,
    {
...
export var DescribeEventConfigurations = [
    9,
    n0,
    _DECe,
    {
...
export var DescribeFleetMetric = [
    9,
    n0,
    _DFMe,
    {
...
export var DescribeManagedJobTemplate = [
    9,
    n0,
    _DMJT,
    {
...
export var DescribeMitigationAction = [
    9,
    n0,
    _DMAe,
    {
...
export var DescribeProvisioningTemplate = [
    9,
    n0,
    _DPTe,
    {
...
export var DescribeProvisioningTemplateVersion = [
    9,
    n0,
    _DPTVe,
    {
...
export var DescribeScheduledAudit = [
    9,
    n0,
    _DSAe,
    {
...
export var DescribeSecurityProfile = [
    9,
    n0,
    _DSPe,
    {
...
export var DescribeThingRegistrationTask = [
    9,
    n0,
    _DTRT,
    {
...
export var DetachPrincipalPolicy = [
    9,
    n0,
    _DPP,
    {
...
export var DetachSecurityProfile = [
    9,
    n0,
    _DSPet,
    {
...
export var DetachThingPrincipal = [
    9,
    n0,
    _DTP,
    {
...
export var DisassociateSbomFromPackageVersion = [
    9,
    n0,
    _DSFPV,
    {
...
export var GetBehaviorModelTrainingSummaries = [
    9,
    n0,
    _GBMTS,
    {
...
export var GetBucketsAggregation = [
    9,
    n0,
    _GBA,
    {
...
export var GetCommandExecution = [
    9,
    n0,
    _GCE,
    {
...
export var GetEffectivePolicies = [
    9,
    n0,
    _GEP,
    {
...
export var GetIndexingConfiguration = [
    9,
    n0,
    _GIC,
    {
...
export var GetPackageConfiguration = [
    9,
    n0,
    _GPC,
    {
...
export var GetRegistrationCode = [
    9,
    n0,
    _GRC,
    {
...
export var GetThingConnectivityData = [
    9,
    n0,
    _GTCD,
    {
...
export var GetTopicRuleDestination = [
    9,
    n0,
    _GTRD,
    {
...
export var GetV2LoggingOptions = [
    9,
    n0,
    _GVLO,
    {
...
export var ListActiveViolations = [
    9,
    n0,
    _LAV,
    {
...
export var ListAttachedPolicies = [
    9,
    n0,
    _LAP,
    {
...
export var ListAuditMitigationActionsExecutions = [
    9,
    n0,
    _LAMAE,
    {
...
export var ListAuditMitigationActionsTasks = [
    9,
    n0,
    _LAMAT,
    {
...
export var ListAuditSuppressions = [
    9,
    n0,
    _LAS,
    {
...
export var ListCertificateProviders = [
    9,
    n0,
    _LCP,
    {
...
export var ListCertificatesByCA = [
    9,
    n0,
    _LCBCA,
    {
...
export var ListCommandExecutions = [
    9,
    n0,
    _LCE,
    {
...
export var ListDetectMitigationActionsExecutions = [
    9,
    n0,
    _LDMAE,
    {
...
export var ListDetectMitigationActionsTasks = [
    9,
    n0,
    _LDMAT,
    {
...
export var ListDomainConfigurations = [
    9,
    n0,
    _LDC,
    {
...
export var ListJobExecutionsForJob = [
    9,
    n0,
    _LJEFJ,
    {
...
export var ListJobExecutionsForThing = [
    9,
    n0,
    _LJEFT,
    {
...
export var ListManagedJobTemplates = [
    9,
    n0,
    _LMJT,
    {
...
export var ListMitigationActions = [
    9,
    n0,
    _LMA,
    {
...
export var ListOutgoingCertificates = [
    9,
    n0,
    _LOC,
    {
...
export var ListPolicyPrincipals = [
    9,
    n0,
    _LPP,
    {
...
export var ListPrincipalPolicies = [
    9,
    n0,
    _LPPi,
    {
...
export var ListPrincipalThings = [
    9,
    n0,
    _LPT,
    {
...
export var ListPrincipalThingsV2 = [
    9,
    n0,
    _LPTV,
    {
...
export var ListProvisioningTemplates = [
    9,
    n0,
    _LPTi,
    {
...
export var ListProvisioningTemplateVersions = [
    9,
    n0,
    _LPTVi,
    {
...
export var ListRelatedResourcesForAuditFinding = [
    9,
    n0,
    _LRRFAF,
    {
...
export var ListSbomValidationResults = [
    9,
    n0,
    _LSVR,
    {
...
export var ListScheduledAudits = [
    9,
    n0,
    _LSA,
    {
...
export var ListSecurityProfiles = [
    9,
    n0,
    _LSP,
    {
...
export var ListSecurityProfilesForTarget = [
    9,
    n0,
    _LSPFT,
    {
...
export var ListTargetsForSecurityProfile = [
    9,
    n0,
    _LTFSP,
    {
...
export var ListThingGroupsForThing = [
    9,
    n0,
    _LTGFT,
    {
...
export var ListThingPrincipals = [
    9,
    n0,
    _LTP,
    {
...
export var ListThingPrincipalsV2 = [
    9,
    n0,
    _LTPV,
    {
...
export var ListThingRegistrationTaskReports = [
    9,
    n0,
    _LTRTRis,
    {
...
export var ListThingRegistrationTasks = [
    9,
    n0,
    _LTRT,
    {
...
export var ListThingsInBillingGroup = [
    9,
    n0,
    _LTIBG,
    {
...
export var ListThingsInThingGroup = [
    9,
    n0,
    _LTITG,
    {
...
export var ListTopicRuleDestinations = [
    9,
    n0,
    _LTRD,
    {
...
export var ListV2LoggingLevels = [
    9,
    n0,
    _LVLL,
    {
...
export var ListViolationEvents = [
    9,
    n0,
    _LVE,
    {
...
export var PutVerificationStateOnViolation = [
    9,
    n0,
    _PVSOV,
    {
...
export var RegisterCACertificate = [
    9,
    n0,
    _RCAC,
    {
...
export var RegisterCertificateWithoutCA = [
    9,
    n0,
    _RCWCA,
    {
...
export var RejectCertificateTransfer = [
    9,
    n0,
    _RCT,
    {
...
export var RemoveThingFromBillingGroup = [
    9,
    n0,
    _RTFBG,
    {
...
export var RemoveThingFromThingGroup = [
    9,
    n0,
    _RTFTG,
    {
...
export var SetDefaultAuthorizer = [
    9,
    n0,
    _SDA,
    {
...
export var SetV2LoggingOptions = [
    9,
    n0,
    _SVLO,
    {
...
export var StartAuditMitigationActionsTask = [
    9,
    n0,
    _SAMAT,
    {
...
export var StartDetectMitigationActionsTask = [
    9,
    n0,
    _SDMAT,
    {
...
export var StartOnDemandAuditTask = [
    9,
    n0,
    _SODAT,
    {
...
export var StartThingRegistrationTask = [
    9,
    n0,
    _STRT,
    {
...
export var StopThingRegistrationTask = [
    9,
    n0,
    _STRTt,
    {
...
export var TransferCertificate = [
    9,
    n0,
    _TCr,
    {
...
export var UpdateAccountAuditConfiguration = [
    9,
    n0,
    _UAAC,
    {
...
export var UpdateAuditSuppression = [
    9,
    n0,
    _UAS,
    {
...
export var UpdateCACertificate = [
    9,
    n0,
    _UCAC,
    {
...
export var UpdateCertificateProvider = [
    9,
    n0,
    _UCP,
    {
...
export var UpdateDomainConfiguration = [
    9,
    n0,
    _UDC,
    {
...
export var UpdateDynamicThingGroup = [
    9,
    n0,
    _UDTG,
    {
...
export var UpdateEncryptionConfiguration = [
    9,
    n0,
    _UEC,
    {
...
export var UpdateEventConfigurations = [
    9,
    n0,
    _UECp,
    {
...
export var UpdateIndexingConfiguration = [
    9,
    n0,
    _UIC,
    {
...
export var UpdateMitigationAction = [
    9,
    n0,
    _UMA,
    {
...
export var UpdatePackageConfiguration = [
    9,
    n0,
    _UPC,
    {
...
export var UpdatePackageVersion = [
    9,
    n0,
    _UPV,
    {
...
export var UpdateProvisioningTemplate = [
    9,
    n0,
    _UPT,
    {
...
export var UpdateScheduledAudit = [
    9,
    n0,
    _USA,
    {
...
export var UpdateSecurityProfile = [
    9,
    n0,
    _USP,
    {
...
export var UpdateThingGroupsForThing = [
    9,
    n0,
    _UTGFT,
    {
...
export var UpdateTopicRuleDestination = [
    9,
    n0,
    _UTRD,
    {
...
export var ValidateSecurityProfileBehaviors = [
    9,
    n0,
    _VSPB,
    {
