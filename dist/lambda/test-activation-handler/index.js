...
const transactionRepo = new transaction_repository_1.TransactionRepository(MONGODB_URI);
const subscriptionRepo = new subscription_repository_1.SubscriptionRepository(MONGODB_URI);
