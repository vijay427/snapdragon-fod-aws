...
import { IResourcePolicyRef, ResourcePolicyReference } from "../../interfaces/generated/aws-kinesis-interfaces.generated";
/**
...
export declare class CfnStream extends cdk.CfnResource implements cdk.IInspectable, IStreamRef, cdk.ITaggable {
     ...
     */
    readonly attrWarmThroughputObject: cdk.IResolvable;
    /**
...
export interface CfnResourcePolicyProps {
     ...
     */
    readonly resourceArn: IStreamConsumerRef | IStreamRef | string;
    /**
     * This is the description for the resource policy.
     *
