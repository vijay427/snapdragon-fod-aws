...
import { IChannelRef, ChannelReference } from "../../interfaces/generated/aws-cloudtrail-interfaces.generated";
import { IEventDataStoreRef, EventDataStoreReference } from "../../interfaces/generated/aws-cloudtrail-interfaces.generated";
import { IResourcePolicyRef, ResourcePolicyReference } from "../../interfaces/generated/aws-cloudtrail-interfaces.generated";
import { ITrailRef, TrailReference } from "../../interfaces/generated/aws-cloudtrail-interfaces.generated";
import { IDashboardRef, DashboardReference } from "../../interfaces/generated/aws-cloudtrail-interfaces.generated";
import { IRoleRef as IamIRoleRef } from "../../aws-iam";
import { IKeyRef as KmsIKeyRef, IAliasRef as KmsIAliasRef } from "../../aws-kms";
...
export declare class CfnEventDataStore extends cdk.CfnResource implements cdk.IInspectable, IEventDataStoreRef, cdk.ITaggable {
     ...
     */
    static isCfnEventDataStore(x: any): x is CfnEventDataStore;
    static arnForEventDataStore(resource: IEventDataStoreRef): string;
    /**
...
export declare class CfnTrail extends cdk.CfnResource implements cdk.IInspectable, ITrailRef, cdk.ITaggable {
     ...
     */
    static isCfnTrail(x: any): x is CfnTrail;
    /**
     * Creates a new ITrailRef from an ARN
     */
    static fromTrailArn(scope: constructs.Construct, id: string, arn: string): ITrailRef;
    /**
     * Creates a new ITrailRef from a trailName
     */
    static fromTrailName(scope: constructs.Construct, id: string, trailName: string): ITrailRef;
    static arnForTrail(resource: ITrailRef): string;
    /**
     ...
     */
    aggregationConfigurations?: Array<CfnTrail.AggregationConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
...
export interface CfnTrailProps {
     ...
     */
    readonly aggregationConfigurations?: Array<CfnTrail.AggregationConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Specifies a log group name using an Amazon Resource Name (ARN), a unique identifier that represents the log group to which CloudTrail logs are delivered.
     *
     ...
     */
    readonly cloudWatchLogsLogGroupArn?: LogsILogGroupRef | string;
    /**
     * Specifies the role for the CloudWatch Logs endpoint to assume to write to a user's log group.
     *
     ...
     */
    readonly cloudWatchLogsRoleArn?: IamIRoleRef | string;
    /**
     * Specifies whether log file validation is enabled. The default is false.
     *
     ...
     */
    readonly kmsKeyId?: KmsIAliasRef | KmsIKeyRef | string;
    /**
     * Specifies the name of the Amazon S3 bucket designated for publishing log files.
     *
     ...
     */
    readonly s3BucketName: S3IBucketRef | string;
    /**
     * Specifies the Amazon S3 key prefix that comes after the name of the bucket you have designated for log file delivery.
     *
...
export type { IEventDataStoreRef, EventDataStoreReference };
export type { IResourcePolicyRef, ResourcePolicyReference };
export type { ITrailRef, TrailReference };
