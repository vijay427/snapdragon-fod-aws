...
import { IFirewallRef, FirewallReference } from "../../interfaces/generated/aws-networkfirewall-interfaces.generated";
import { IFirewallPolicyRef, FirewallPolicyReference } from "../../interfaces/generated/aws-networkfirewall-interfaces.generated";
import { ILoggingConfigurationRef, LoggingConfigurationReference } from "../../interfaces/generated/aws-networkfirewall-interfaces.generated";
import { IRuleGroupRef, RuleGroupReference } from "../../interfaces/generated/aws-networkfirewall-interfaces.generated";
import { ITLSInspectionConfigurationRef, TLSInspectionConfigurationReference } from "../../interfaces/generated/aws-networkfirewall-interfaces.generated";
import { IVpcEndpointAssociationRef, VpcEndpointAssociationReference } from "../../interfaces/generated/aws-networkfirewall-interfaces.generated";
import { IVPCRef as Ec2IVPCRef } from "../../aws-ec2";
/**
 ...
 */
export declare class CfnFirewall extends cdk.CfnResource implements cdk.IInspectable, IFirewallRef, cdk.ITaggable {
    /**
     ...
     */
    static isCfnFirewall(x: any): x is CfnFirewall;
    static arnForFirewall(resource: IFirewallRef): string;
    /**
    ...
    get firewallRef(): FirewallReference;
...
export interface CfnFirewallProps {
     ...
     */
    readonly firewallPolicyArn: IFirewallPolicyRef | string;
    /**
     * A setting indicating whether the firewall is protected against a change to the firewall policy association.
     *
 ...
 */
export declare class CfnFirewallPolicy extends cdk.CfnResource implements cdk.IInspectable, IFirewallPolicyRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnFirewallPolicy(x: any): x is CfnFirewallPolicy;
    static arnForFirewallPolicy(resource: IFirewallPolicyRef): string;
    /**
     * The Amazon Resource Name (ARN) of the firewall policy.
     *
    ...
    get firewallPolicyRef(): FirewallPolicyReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnFirewallPolicy {
    ...
    interface FirewallPolicyProperty {
         ...
         */
        readonly enableTlsSessionHolding?: boolean | cdk.IResolvable;
        /**
...
export interface CfnLoggingConfigurationProps {
     ...
     */
    readonly firewallArn: IFirewallRef | string;
    /**
     * The name of the firewall that the logging configuration is associated with.
     *
     * You can't change the firewall specification after you create the logging configuration.
 ...
 */
export declare class CfnTLSInspectionConfiguration extends cdk.CfnResource implements cdk.IInspectable, ITLSInspectionConfigurationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnTLSInspectionConfiguration(x: any): x is CfnTLSInspectionConfiguration;
    static arnForTLSInspectionConfiguration(resource: ITLSInspectionConfigurationRef): string;
    /**
     * The Amazon Resource Name (ARN) of the TLS inspection configuration.
     *
    ...
    get tlsInspectionConfigurationRef(): TLSInspectionConfigurationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnVpcEndpointAssociation extends cdk.CfnResource implements cdk.IInspectable, IVpcEndpointAssociationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnVpcEndpointAssociation(x: any): x is CfnVpcEndpointAssociation;
    static arnForVpcEndpointAssociation(resource: IVpcEndpointAssociationRef): string;
    /**
    ...
    get vpcEndpointAssociationRef(): VpcEndpointAssociationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IFirewallRef, FirewallReference };
export type { IFirewallPolicyRef, FirewallPolicyReference };
export type { ILoggingConfigurationRef, LoggingConfigurationReference };
export type { IRuleGroupRef, RuleGroupReference };
export type { ITLSInspectionConfigurationRef, TLSInspectionConfigurationReference };
export type { IVpcEndpointAssociationRef, VpcEndpointAssociationReference };
