 ...
 */
export declare function formatAnalytics(infos: ConstructInfo[], enableAdditionalTelemtry?: boolean): string;
/**
 ...
 * @internal
 */
export declare function parseAnalytics(analyticsString: string): ConstructInfo[];
