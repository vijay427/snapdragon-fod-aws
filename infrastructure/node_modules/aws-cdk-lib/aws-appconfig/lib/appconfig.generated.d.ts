...
import { IConfigurationProfileRef, ConfigurationProfileReference } from "../../interfaces/generated/aws-appconfig-interfaces.generated";
import { IDeploymentRef, DeploymentReference } from "../../interfaces/generated/aws-appconfig-interfaces.generated";
...
import { IExtensionAssociationRef, ExtensionAssociationReference } from "../../interfaces/generated/aws-appconfig-interfaces.generated";
import { IHostedConfigurationVersionRef, HostedConfigurationVersionReference } from "../../interfaces/generated/aws-appconfig-interfaces.generated";
...
export declare class CfnConfigurationProfile extends cdk.CfnResource implements cdk.IInspectable, IConfigurationProfileRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnConfigurationProfile(x: any): x is CfnConfigurationProfile;
    /**
    ...
    /**
     * The Amazon Resource Name of the AWS Key Management Service key to encrypt new configuration data versions in the AWS AppConfig hosted configuration store. This attribute is only used for `hosted` configuration types. To encrypt data managed in other configuration stores, see the documentation for how to specify an AWS  key for that particular service.
     *
...
export interface CfnConfigurationProfileProps {
     ...
     */
    readonly applicationId: IApplicationRef | string;
    /**
     * A parameter to configure deletion protection.
     *
     ...
     */
    readonly retrievalRoleArn?: IamIRoleRef | string;
    /**
     * Metadata to assign to the configuration profile.
     *
     * Tags help organize and categorize your AWS AppConfig resources. Each tag consists of a key and an optional value, both of which you define.
...
export declare class CfnDeploymentStrategy extends cdk.CfnResource implements cdk.IInspectable, IDeploymentStrategyRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnDeploymentStrategy(x: any): x is CfnDeploymentStrategy;
    /**
     * Creates a new IDeploymentStrategyRef from a deploymentStrategyId
     */
    static fromDeploymentStrategyId(scope: constructs.Construct, id: string, deploymentStrategyId: string): IDeploymentStrategyRef;
    static arnForDeploymentStrategy(resource: IDeploymentStrategyRef): string;
    /**
     * The deployment strategy ID.
     *
...
export declare class CfnExtension extends cdk.CfnResource implements cdk.IInspectable, IExtensionRef, cdk.ITaggable {
     ...
     */
    static isCfnExtension(x: any): x is CfnExtension;
    static arnForExtension(resource: IExtensionRef): string;
    /**
...
export declare class CfnExtensionAssociation extends cdk.CfnResource implements cdk.IInspectable, IExtensionAssociationRef, cdk.ITaggable {
     ...
     */
    static isCfnExtensionAssociation(x: any): x is CfnExtensionAssociation;
    /**
     * Creates a new IExtensionAssociationRef from an ARN
     */
    static fromExtensionAssociationArn(scope: constructs.Construct, id: string, arn: string): IExtensionAssociationRef;
    /**
     * Creates a new IExtensionAssociationRef from a extensionAssociationId
     */
    static fromExtensionAssociationId(scope: constructs.Construct, id: string, extensionAssociationId: string): IExtensionAssociationRef;
    static arnForExtensionAssociation(resource: IExtensionAssociationRef): string;
    /**
...
export declare class CfnHostedConfigurationVersion extends cdk.CfnResource implements cdk.IInspectable, IHostedConfigurationVersionRef {
     ...
     */
    static isCfnHostedConfigurationVersion(x: any): x is CfnHostedConfigurationVersion;
    /**
...
export interface CfnHostedConfigurationVersionProps {
     ...
     */
    readonly configurationProfileId: IConfigurationProfileRef | string;
    /**
     * The configuration data, as bytes.
     *
...
export type { IConfigurationProfileRef, ConfigurationProfileReference };
export type { IDeploymentRef, DeploymentReference };
export type { IDeploymentStrategyRef, DeploymentStrategyReference };
export type { IEnvironmentRef, EnvironmentReference };
export type { IExtensionRef, ExtensionReference };
export type { IExtensionAssociationRef, ExtensionAssociationReference };
export type { IHostedConfigurationVersionRef, HostedConfigurationVersionReference };
