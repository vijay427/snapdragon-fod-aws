...
import { IAccessorRef, AccessorReference } from "../../interfaces/generated/aws-managedblockchain-interfaces.generated";
import { IMemberRef, MemberReference } from "../../interfaces/generated/aws-managedblockchain-interfaces.generated";
import { INodeRef, NodeReference } from "../../interfaces/generated/aws-managedblockchain-interfaces.generated";
/**
...
export declare class CfnAccessor extends cdk.CfnResource implements cdk.IInspectable, IAccessorRef, cdk.ITaggable {
     ...
     */
    static isCfnAccessor(x: any): x is CfnAccessor;
    /**
     * Creates a new IAccessorRef from an ARN
     */
    static fromAccessorArn(scope: constructs.Construct, id: string, arn: string): IAccessorRef;
    /**
     * Creates a new IAccessorRef from a accessorId
     */
    static fromAccessorId(scope: constructs.Construct, id: string, accessorId: string): IAccessorRef;
    static arnForAccessor(resource: IAccessorRef): string;
    /**
...
export declare class CfnMember extends cdk.CfnResource implements cdk.IInspectable, IMemberRef {
     ...
     */
    static fromMemberId(scope: constructs.Construct, id: string, memberId: string): IMemberRef;
    static arnForMember(resource: IMemberRef): string;
    /**
...
export declare class CfnNode extends cdk.CfnResource implements cdk.IInspectable, INodeRef {
     ...
     */
    static fromNodeArn(scope: constructs.Construct, id: string, arn: string): INodeRef;
    /**
     * Creates a new INodeRef from a nodeId
     */
    static fromNodeId(scope: constructs.Construct, id: string, nodeId: string): INodeRef;
...
export type { IAccessorRef, AccessorReference };
