...
import { ISubscriptionRef, SubscriptionReference } from "../../interfaces/generated/aws-sns-interfaces.generated";
import { ITopicRef, TopicReference } from "../../interfaces/generated/aws-sns-interfaces.generated";
import { ITopicInlinePolicyRef, TopicInlinePolicyReference } from "../../interfaces/generated/aws-sns-interfaces.generated";
import { ITopicPolicyRef, TopicPolicyReference } from "../../interfaces/generated/aws-sns-interfaces.generated";
...
import { IFunctionRef as LambdaIFunctionRef, IVersionRef as LambdaIVersionRef } from "../../aws-lambda";
...
export interface CfnSubscriptionProps {
     ...
     */
    readonly endpoint?: KinesisFirehoseIDeliveryStreamRef | LambdaIFunctionRef | LambdaIVersionRef | SqsIQueueRef | string;
    /**
     * The filter policy JSON assigned to the subscription.
     *
     ...
     */
    readonly subscriptionRoleArn?: IamIRoleRef | string;
    /**
     * The ARN of the topic to subscribe to.
     *
     ...
     */
    readonly topicArn: ITopicRef | string;
}
/**
...
export interface CfnTopicProps {
     ...
     */
    readonly kmsMasterKeyId?: KmsIAliasRef | KmsIKeyRef | string;
    /**
     * The signature version corresponds to the hashing algorithm used while creating the signature of the notifications, subscription confirmations, or unsubscribe confirmation messages sent by Amazon SNS.
     *
