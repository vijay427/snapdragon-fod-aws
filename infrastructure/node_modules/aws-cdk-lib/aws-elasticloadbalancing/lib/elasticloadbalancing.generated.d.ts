...
import { IInstanceRef as Ec2IInstanceRef, ISecurityGroupRef as Ec2ISecurityGroupRef, ISubnetRef as Ec2ISubnetRef } from "../../aws-ec2";
/**
...
export interface CfnLoadBalancerProps {
     ...
     */
    readonly instances?: Array<Ec2IInstanceRef | string>;
    /**
     * Information about a policy for duration-based session stickiness.
     *
