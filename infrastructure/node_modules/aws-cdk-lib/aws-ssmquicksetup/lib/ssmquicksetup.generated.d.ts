...
import { IConfigurationManagerRef, ConfigurationManagerReference } from "../../interfaces/generated/aws-ssmquicksetup-interfaces.generated";
import { ILifecycleAutomationRef, LifecycleAutomationReference } from "../../interfaces/generated/aws-ssmquicksetup-interfaces.generated";
/**
...
export declare class CfnConfigurationManager extends cdk.CfnResource implements cdk.IInspectable, IConfigurationManagerRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnConfigurationManager(x: any): x is CfnConfigurationManager;
    /**
 ...
 */
export declare class CfnLifecycleAutomation extends cdk.CfnResource implements cdk.IInspectable, ILifecycleAutomationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnLifecycleAutomation from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnLifecycleAutomation;
    /**
     * Checks whether the given object is a CfnLifecycleAutomation
     */
    static isCfnLifecycleAutomation(x: any): x is CfnLifecycleAutomation;
    /**
     ...
     */
    automationParameters: cdk.IResolvable | Record<string, Array<string>>;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnLifecycleAutomationProps);
    get lifecycleAutomationRef(): LifecycleAutomationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ssmquicksetup-lifecycleautomation.html
 */
export interface CfnLifecycleAutomationProps {
    /**
     * The name of the SSM Automation document to execute in response to CloudFormation lifecycle events (CREATE, UPDATE, DELETE).
     *
     ...
     */
    readonly automationParameters: cdk.IResolvable | Record<string, Array<string>>;
    /**
     * A unique identifier used for generating the SSM Association name.
     *
...
export type { IConfigurationManagerRef, ConfigurationManagerReference };
export type { ILifecycleAutomationRef, LifecycleAutomationReference };
