...
import { IComponentTypeRef, ComponentTypeReference } from "../../interfaces/generated/aws-iottwinmaker-interfaces.generated";
import { IEntityRef, EntityReference } from "../../interfaces/generated/aws-iottwinmaker-interfaces.generated";
import { ISceneRef, SceneReference } from "../../interfaces/generated/aws-iottwinmaker-interfaces.generated";
import { ISyncJobRef, SyncJobReference } from "../../interfaces/generated/aws-iottwinmaker-interfaces.generated";
import { IWorkspaceRef, WorkspaceReference } from "../../interfaces/generated/aws-iottwinmaker-interfaces.generated";
...
export declare class CfnComponentType extends cdk.CfnResource implements cdk.IInspectable, IComponentTypeRef, cdk.ITaggable {
     ...
     */
    static isCfnComponentType(x: any): x is CfnComponentType;
    static arnForComponentType(resource: IComponentTypeRef): string;
    /**
...
export declare class CfnEntity extends cdk.CfnResource implements cdk.IInspectable, IEntityRef, cdk.ITaggable {
     ...
     */
    static isCfnEntity(x: any): x is CfnEntity;
    static arnForEntity(resource: IEntityRef): string;
    /**
     * The entity ARN.
     *
     * @cloudformationAttribute Arn
...
export declare class CfnScene extends cdk.CfnResource implements cdk.IInspectable, ISceneRef, cdk.ITaggable {
     ...
     */
    static isCfnScene(x: any): x is CfnScene;
    static arnForScene(resource: ISceneRef): string;
    /**
     * The scene ARN.
     *
     * @cloudformationAttribute Arn
...
export declare class CfnSyncJob extends cdk.CfnResource implements cdk.IInspectable, ISyncJobRef, cdk.ITaggable {
     ...
     */
    static isCfnSyncJob(x: any): x is CfnSyncJob;
    static arnForSyncJob(resource: ISyncJobRef): string;
    /**
     * The SyncJob ARN.
     *
     * @cloudformationAttribute Arn
...
export declare class CfnWorkspace extends cdk.CfnResource implements cdk.IInspectable, IWorkspaceRef, cdk.ITaggable {
     ...
     */
    static fromWorkspaceArn(scope: constructs.Construct, id: string, arn: string): IWorkspaceRef;
    /**
...
export interface CfnWorkspaceProps {
     ...
     */
    readonly s3Location: S3IBucketRef | string;
    /**
     * Metadata that you can use to manage the workspace.
     *
...
export type { IComponentTypeRef, ComponentTypeReference };
export type { IEntityRef, EntityReference };
export type { ISceneRef, SceneReference };
export type { ISyncJobRef, SyncJobReference };
