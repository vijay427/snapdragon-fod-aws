...
import { IAlarmModelRef, AlarmModelReference } from "../../interfaces/generated/aws-iotevents-interfaces.generated";
import { IDetectorModelRef, DetectorModelReference } from "../../interfaces/generated/aws-iotevents-interfaces.generated";
import { IInputRef, InputReference } from "../../interfaces/generated/aws-iotevents-interfaces.generated";
...
export declare class CfnAlarmModel extends cdk.CfnResource implements cdk.IInspectable, IAlarmModelRef, cdk.ITaggable {
     ...
     */
    static isCfnAlarmModel(x: any): x is CfnAlarmModel;
    /**
     * Creates a new IAlarmModelRef from a alarmModelName
     */
    static fromAlarmModelName(scope: constructs.Construct, id: string, alarmModelName: string): IAlarmModelRef;
    static arnForAlarmModel(resource: IAlarmModelRef): string;
    /**
...
export declare class CfnDetectorModel extends cdk.CfnResource implements cdk.IInspectable, IDetectorModelRef, cdk.ITaggable {
     ...
     */
    static isCfnDetectorModel(x: any): x is CfnDetectorModel;
    /**
     * Creates a new IDetectorModelRef from a detectorModelName
     */
    static fromDetectorModelName(scope: constructs.Construct, id: string, detectorModelName: string): IDetectorModelRef;
    static arnForDetectorModel(resource: IDetectorModelRef): string;
    /**
...
export declare class CfnInput extends cdk.CfnResource implements cdk.IInspectable, IInputRef, cdk.ITaggable {
     ...
     */
    static fromInputName(scope: constructs.Construct, id: string, inputName: string): IInputRef;
...
export type { IAlarmModelRef, AlarmModelReference };
export type { IDetectorModelRef, DetectorModelReference };
