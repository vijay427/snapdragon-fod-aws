...
import { IAccessPointRef, AccessPointReference } from "../../interfaces/generated/aws-efs-interfaces.generated";
import { IFileSystemRef, FileSystemReference } from "../../interfaces/generated/aws-efs-interfaces.generated";
import { IMountTargetRef, MountTargetReference } from "../../interfaces/generated/aws-efs-interfaces.generated";
...
export declare class CfnAccessPoint extends cdk.CfnResource implements cdk.IInspectable, IAccessPointRef, cdk.ITaggable {
     ...
     */
    static fromAccessPointId(scope: constructs.Construct, id: string, accessPointId: string): IAccessPointRef;
...
export interface CfnAccessPointProps {
     ...
     */
    readonly fileSystemId: IFileSystemRef | string;
    /**
     * The full POSIX identity, including the user ID, group ID, and secondary group IDs on the access point that is used for all file operations by NFS clients using the access point.
     *
...
export declare class CfnFileSystem extends cdk.CfnResource implements cdk.IInspectable, IFileSystemRef, cdk.ITaggable {
     ...
     */
    static fromFileSystemArn(scope: constructs.Construct, id: string, arn: string): IFileSystemRef;
    /**
     * Creates a new IFileSystemRef from a fileSystemId
     */
    static fromFileSystemId(scope: constructs.Construct, id: string, fileSystemId: string): IFileSystemRef;
...
export interface CfnMountTargetProps {
     ...
     */
    readonly subnetId: Ec2ISubnetRef | string;
}
