...
import { IGeofenceCollectionRef, GeofenceCollectionReference } from "../../interfaces/generated/aws-location-interfaces.generated";
import { IMapRef, MapReference } from "../../interfaces/generated/aws-location-interfaces.generated";
import { IPlaceIndexRef, PlaceIndexReference } from "../../interfaces/generated/aws-location-interfaces.generated";
import { IRouteCalculatorRef, RouteCalculatorReference } from "../../interfaces/generated/aws-location-interfaces.generated";
import { ITrackerRef, TrackerReference } from "../../interfaces/generated/aws-location-interfaces.generated";
import { ITrackerConsumerRef, TrackerConsumerReference } from "../../interfaces/generated/aws-location-interfaces.generated";
import { IAPIKeyRef, APIKeyReference } from "../../interfaces/generated/aws-location-interfaces.generated";
/**
...
export declare class CfnGeofenceCollection extends cdk.CfnResource implements cdk.IInspectable, IGeofenceCollectionRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnGeofenceCollection(x: any): x is CfnGeofenceCollection;
    /**
     * Creates a new IGeofenceCollectionRef from an ARN
     */
    static fromGeofenceCollectionArn(scope: constructs.Construct, id: string, arn: string): IGeofenceCollectionRef;
    /**
     * Creates a new IGeofenceCollectionRef from a collectionName
     */
    static fromCollectionName(scope: constructs.Construct, id: string, collectionName: string): IGeofenceCollectionRef;
    static arnForGeofenceCollection(resource: IGeofenceCollectionRef): string;
    /**
...
export declare class CfnMap extends cdk.CfnResource implements cdk.IInspectable, IMapRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnMap(x: any): x is CfnMap;
    /**
     * Creates a new IMapRef from an ARN
     */
    static fromMapArn(scope: constructs.Construct, id: string, arn: string): IMapRef;
    /**
     * Creates a new IMapRef from a mapName
     */
    static fromMapName(scope: constructs.Construct, id: string, mapName: string): IMapRef;
    static arnForMap(resource: IMapRef): string;
    /**
...
export declare class CfnPlaceIndex extends cdk.CfnResource implements cdk.IInspectable, IPlaceIndexRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnPlaceIndex(x: any): x is CfnPlaceIndex;
    /**
     * Creates a new IPlaceIndexRef from an ARN
     */
    static fromPlaceIndexArn(scope: constructs.Construct, id: string, arn: string): IPlaceIndexRef;
    /**
     * Creates a new IPlaceIndexRef from a indexName
     */
    static fromIndexName(scope: constructs.Construct, id: string, indexName: string): IPlaceIndexRef;
...
export declare class CfnRouteCalculator extends cdk.CfnResource implements cdk.IInspectable, IRouteCalculatorRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnRouteCalculator(x: any): x is CfnRouteCalculator;
    /**
     * Creates a new IRouteCalculatorRef from an ARN
     */
    static fromRouteCalculatorArn(scope: constructs.Construct, id: string, arn: string): IRouteCalculatorRef;
    /**
     * Creates a new IRouteCalculatorRef from a calculatorName
     */
    static fromCalculatorName(scope: constructs.Construct, id: string, calculatorName: string): IRouteCalculatorRef;
    static arnForRouteCalculator(resource: IRouteCalculatorRef): string;
    /**
...
export declare class CfnTracker extends cdk.CfnResource implements cdk.IInspectable, ITrackerRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnTracker(x: any): x is CfnTracker;
    /**
     * Creates a new ITrackerRef from an ARN
     */
    static fromTrackerArn(scope: constructs.Construct, id: string, arn: string): ITrackerRef;
    /**
     * Creates a new ITrackerRef from a trackerName
     */
    static fromTrackerName(scope: constructs.Construct, id: string, trackerName: string): ITrackerRef;
    static arnForTracker(resource: ITrackerRef): string;
    /**
...
export declare class CfnTrackerConsumer extends cdk.CfnResource implements cdk.IInspectable, ITrackerConsumerRef {
     ...
     */
    static isCfnTrackerConsumer(x: any): x is CfnTrackerConsumer;
    /**
...
export declare class CfnAPIKey extends cdk.CfnResource implements cdk.IInspectable, IAPIKeyRef, cdk.ITaggableV2 {
     ...
     */
    static fromAPIKeyArn(scope: constructs.Construct, id: string, arn: string): IAPIKeyRef;
    /**
     * Creates a new IAPIKeyRef from a keyName
     */
    static fromKeyName(scope: constructs.Construct, id: string, keyName: string): IAPIKeyRef;
...
export declare namespace CfnAPIKey {
    ...
    interface ApiKeyRestrictionsProperty {
         ...
         */
        readonly allowAndroidApps?: Array<CfnAPIKey.AndroidAppProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
         ...
         */
        readonly allowAppleApps?: Array<CfnAPIKey.AppleAppProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
...
export type { IGeofenceCollectionRef, GeofenceCollectionReference };
export type { IMapRef, MapReference };
export type { IPlaceIndexRef, PlaceIndexReference };
export type { IRouteCalculatorRef, RouteCalculatorReference };
export type { ITrackerRef, TrackerReference };
export type { ITrackerConsumerRef, TrackerConsumerReference };
