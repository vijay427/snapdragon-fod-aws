...
import { IIndexRef, IndexReference } from "../../interfaces/generated/aws-s3vectors-interfaces.generated";
import { IVectorBucketRef, VectorBucketReference } from "../../interfaces/generated/aws-s3vectors-interfaces.generated";
import { IVectorBucketPolicyRef, VectorBucketPolicyReference } from "../../interfaces/generated/aws-s3vectors-interfaces.generated";
/**
...
export declare class CfnIndex extends cdk.CfnResource implements cdk.IInspectable, IIndexRef {
     ...
     */
    metadataConfiguration?: cdk.IResolvable | CfnIndex.MetadataConfigurationProperty;
    /**
...
export interface CfnIndexProps {
     ...
     */
    readonly metadataConfiguration?: cdk.IResolvable | CfnIndex.MetadataConfigurationProperty;
    /**
     * The Amazon Resource Name (ARN) of the vector bucket that contains the vector index.
     *
 ...
 */
export declare class CfnVectorBucket extends cdk.CfnResource implements cdk.IInspectable, IVectorBucketRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnVectorBucket from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnVectorBucket;
    /**
     * Checks whether the given object is a CfnVectorBucket
     */
    static isCfnVectorBucket(x: any): x is CfnVectorBucket;
    static arnForVectorBucket(resource: IVectorBucketRef): string;
    /**
     ...
     */
    readonly attrVectorBucketArn: string;
    /**
     * The encryption configuration for the vector bucket.
     */
    encryptionConfiguration?: CfnVectorBucket.EncryptionConfigurationProperty | cdk.IResolvable;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnVectorBucketProps);
...
export declare namespace CfnVectorBucket {
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3vectors-vectorbucket.html
 */
export interface CfnVectorBucketProps {
    /**
     * The encryption configuration for the vector bucket.
     *
     ...
     */
    readonly encryptionConfiguration?: CfnVectorBucket.EncryptionConfigurationProperty | cdk.IResolvable;
    /**
     * A name for the vector bucket.
     *
 ...
 */
export declare class CfnVectorBucketPolicy extends cdk.CfnResource implements cdk.IInspectable, IVectorBucketPolicyRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnVectorBucketPolicy from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnVectorBucketPolicy;
    /**
     * Checks whether the given object is a CfnVectorBucketPolicy
     */
    static isCfnVectorBucketPolicy(x: any): x is CfnVectorBucketPolicy;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnVectorBucketPolicyProps);
    get vectorBucketPolicyRef(): VectorBucketPolicyReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3vectors-vectorbucketpolicy.html
 */
export interface CfnVectorBucketPolicyProps {
    /**
     * A policy document containing permissions to add to the specified vector bucket.
     *
...
export type { IVectorBucketRef, VectorBucketReference };
