...
import { IAssessmentRef, AssessmentReference } from "../../interfaces/generated/aws-auditmanager-interfaces.generated";
/**
...
export declare class CfnAssessment extends cdk.CfnResource implements cdk.IInspectable, IAssessmentRef, cdk.ITaggable {
     ...
     */
    static isCfnAssessment(x: any): x is CfnAssessment;
    /**
     * Creates a new IAssessmentRef from an ARN
     */
    static fromAssessmentArn(scope: constructs.Construct, id: string, arn: string): IAssessmentRef;
    /**
     * Creates a new IAssessmentRef from a assessmentId
     */
    static fromAssessmentId(scope: constructs.Construct, id: string, assessmentId: string): IAssessmentRef;
    static arnForAssessment(resource: IAssessmentRef): string;
    /**
...
export type { IAssessmentRef, AssessmentReference };
