...
import { IAutoScalingGroupRef, AutoScalingGroupReference } from "../../interfaces/generated/aws-autoscaling-interfaces.generated";
import { ILaunchConfigurationRef, LaunchConfigurationReference } from "../../interfaces/generated/aws-autoscaling-interfaces.generated";
import { ILifecycleHookRef, LifecycleHookReference } from "../../interfaces/generated/aws-autoscaling-interfaces.generated";
import { IScalingPolicyRef, ScalingPolicyReference } from "../../interfaces/generated/aws-autoscaling-interfaces.generated";
import { IScheduledActionRef, ScheduledActionReference } from "../../interfaces/generated/aws-autoscaling-interfaces.generated";
import { IWarmPoolRef, WarmPoolReference } from "../../interfaces/generated/aws-autoscaling-interfaces.generated";
import { ISubnetRef as Ec2ISubnetRef, ISecurityGroupRef as Ec2ISecurityGroupRef } from "../../aws-ec2";
import { ILoadBalancerRef as ElasticLoadBalancingILoadBalancerRef } from "../../aws-elasticloadbalancing";
import { ITargetGroupRef as ElasticLoadBalancingV2ITargetGroupRef } from "../../aws-elasticloadbalancingv2";
import { IRoleRef as IamIRoleRef, IInstanceProfileRef as IamIInstanceProfileRef } from "../../aws-iam";
...
export interface CfnAutoScalingGroupProps {
     ...
     */
    readonly launchConfigurationName?: ILaunchConfigurationRef | string;
    /**
     * Information used to specify the launch template and version to use to launch instances.
     *
     ...
     */
    readonly loadBalancerNames?: Array<ElasticLoadBalancingILoadBalancerRef | string>;
    /**
     * The maximum amount of time, in seconds, that an instance can be in service.
     *
     ...
     */
    readonly serviceLinkedRoleArn?: IamIRoleRef | string;
    /**
     ...
     */
    readonly targetGroupArns?: Array<ElasticLoadBalancingV2ITargetGroupRef | string>;
    /**
     * A policy or a list of policies that are used to select the instance to terminate.
     *
     ...
     */
    readonly vpcZoneIdentifier?: Array<Ec2ISubnetRef | string>;
}
/**
...
export interface CfnLaunchConfigurationProps {
     ...
     */
    readonly iamInstanceProfile?: IamIInstanceProfileRef | string;
    /**
     * The ID of the Amazon Machine Image (AMI) that was assigned during registration.
     *
     ...
     */
    readonly securityGroups?: Array<Ec2ISecurityGroupRef | string>;
    /**
     * The maximum hourly price to be paid for any Spot Instance launched to fulfill the request.
     *
...
export interface CfnLifecycleHookProps {
     ...
     */
    readonly autoScalingGroupName: IAutoScalingGroupRef | string;
    /**
     * The action the Auto Scaling group takes when the lifecycle hook timeout elapses or if an unexpected failure occurs.
     *
     * The default value is `ABANDON` .
     ...
     */
    readonly notificationTargetArn?: SnsITopicRef | SqsIQueueRef | string;
    /**
     * The ARN of the IAM role that allows the Auto Scaling group to publish to the specified notification target.
     *
     * For information about creating this role, see [Prepare to add a lifecycle hook to your Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/prepare-for-lifecycle-notifications.html) in the *Amazon EC2 Auto Scaling User Guide* .
