...
import { IDiscoveryRef, DiscoveryReference } from "../../interfaces/generated/aws-applicationsignals-interfaces.generated";
import { IGroupingConfigurationRef, GroupingConfigurationReference } from "../../interfaces/generated/aws-applicationsignals-interfaces.generated";
import { IServiceLevelObjectiveRef, ServiceLevelObjectiveReference } from "../../interfaces/generated/aws-applicationsignals-interfaces.generated";
/**
...
export declare class CfnDiscovery extends cdk.CfnResource implements cdk.IInspectable, IDiscoveryRef {
     ...
     */
    static isCfnDiscovery(x: any): x is CfnDiscovery;
    /**
 ...
 */
export declare class CfnGroupingConfiguration extends cdk.CfnResource implements cdk.IInspectable, IGroupingConfigurationRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnGroupingConfiguration from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnGroupingConfiguration;
    /**
     * Checks whether the given object is a CfnGroupingConfiguration
     */
    static isCfnGroupingConfiguration(x: any): x is CfnGroupingConfiguration;
    /**
     * The 12 digit AWS Account ID for the account.
     *
     * @cloudformationAttribute AccountId
     ...
     */
    groupingAttributeDefinitions: Array<CfnGroupingConfiguration.GroupingAttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnGroupingConfigurationProps);
    get groupingConfigurationRef(): GroupingConfigurationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnGroupingConfiguration {
    /**
    ...
    interface GroupingAttributeDefinitionProperty {
         ...
         */
        readonly groupingSourceKeys: Array<string>;
    }
}
/**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-applicationsignals-groupingconfiguration.html
 */
export interface CfnGroupingConfigurationProps {
    /**
     * An array of grouping attribute definitions that specify how services should be grouped based on various attributes and source keys.
     *
     ...
     */
    readonly groupingAttributeDefinitions: Array<CfnGroupingConfiguration.GroupingAttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable;
}
/**
...
export declare class CfnServiceLevelObjective extends cdk.CfnResource implements cdk.IInspectable, IServiceLevelObjectiveRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnServiceLevelObjective(x: any): x is CfnServiceLevelObjective;
    static arnForServiceLevelObjective(resource: IServiceLevelObjectiveRef): string;
    /**
     * The ARN of this SLO.
     *
...
export type { IDiscoveryRef, DiscoveryReference };
export type { IGroupingConfigurationRef, GroupingConfigurationReference };
export type { IServiceLevelObjectiveRef, ServiceLevelObjectiveReference };
