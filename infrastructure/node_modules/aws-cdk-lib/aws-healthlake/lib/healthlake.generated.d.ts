...
import { IFHIRDatastoreRef, FHIRDatastoreReference } from "../../interfaces/generated/aws-healthlake-interfaces.generated";
/**
 ...
 */
export declare class CfnFHIRDatastore extends cdk.CfnResource implements cdk.IInspectable, IFHIRDatastoreRef, cdk.ITaggable {
    /**
     ...
     */
    static isCfnFHIRDatastore(x: any): x is CfnFHIRDatastore;
    /**
     * Creates a new IFHIRDatastoreRef from an ARN
     */
    static fromFHIRDatastoreArn(scope: constructs.Construct, id: string, arn: string): IFHIRDatastoreRef;
    /**
     * Creates a new IFHIRDatastoreRef from a datastoreId
     */
    static fromDatastoreId(scope: constructs.Construct, id: string, datastoreId: string): IFHIRDatastoreRef;
    static arnForFHIRDatastore(resource: IFHIRDatastoreRef): string;
    /**
    ...
    get fhirDatastoreRef(): FHIRDatastoreReference;
...
export type { IFHIRDatastoreRef, FHIRDatastoreReference };
