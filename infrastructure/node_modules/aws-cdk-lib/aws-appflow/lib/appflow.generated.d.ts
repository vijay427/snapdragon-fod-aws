...
import { IConnectorRef, ConnectorReference } from "../../interfaces/generated/aws-appflow-interfaces.generated";
import { IConnectorProfileRef, ConnectorProfileReference } from "../../interfaces/generated/aws-appflow-interfaces.generated";
import { IFlowRef, FlowReference } from "../../interfaces/generated/aws-appflow-interfaces.generated";
...
export declare class CfnConnector extends cdk.CfnResource implements cdk.IInspectable, IConnectorRef {
     ...
     */
    static fromConnectorLabel(scope: constructs.Construct, id: string, connectorLabel: string): IConnectorRef;
...
export declare class CfnConnectorProfile extends cdk.CfnResource implements cdk.IInspectable, IConnectorProfileRef {
     ...
     */
    static isCfnConnectorProfile(x: any): x is CfnConnectorProfile;
    static arnForConnectorProfile(resource: IConnectorProfileRef): string;
    /**
...
export declare class CfnFlow extends cdk.CfnResource implements cdk.IInspectable, IFlowRef, cdk.ITaggable {
     ...
     */
    static fromFlowArn(scope: constructs.Construct, id: string, arn: string): IFlowRef;
    /**
     * Creates a new IFlowRef from a flowName
     */
    static fromFlowName(scope: constructs.Construct, id: string, flowName: string): IFlowRef;
...
export interface CfnFlowProps {
     ...
     */
    readonly kmsArn?: KmsIKeyRef | string;
    /**
     * Specifies the configuration that Amazon AppFlow uses when it catalogs your data.
     *
     * When Amazon AppFlow catalogs your data, it stores metadata in a data catalog.
...
export type { IConnectorProfileRef, ConnectorProfileReference };
