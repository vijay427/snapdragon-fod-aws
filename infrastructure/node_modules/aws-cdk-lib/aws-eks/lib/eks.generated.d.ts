...
import { IAddonRef, AddonReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { IClusterRef, ClusterReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { IFargateProfileRef, FargateProfileReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { IIdentityProviderConfigRef, IdentityProviderConfigReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { INodegroupRef, NodegroupReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { IAccessEntryRef, AccessEntryReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { ICapabilityRef, CapabilityReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { IPodIdentityAssociationRef, PodIdentityAssociationReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
import { ISubnetRef as Ec2ISubnetRef } from "../../aws-ec2";
...
export interface CfnAddonProps {
     ...
     */
    readonly serviceAccountRoleArn?: IamIRoleRef | string;
    /**
     * The metadata that you apply to the add-on to assist with categorization and organization.
     *
...
export declare class CfnCluster extends cdk.CfnResource implements cdk.IInspectable, IClusterRef, cdk.ITaggable {
     ...
     */
    controlPlaneScalingConfig?: CfnCluster.ControlPlaneScalingConfigProperty | cdk.IResolvable;
    /**
...
export interface CfnNodegroupProps {
     ...
     */
    readonly clusterName: IClusterRef | string;
    /**
     * The root device disk size (in GiB) for your node group instances.
     *
     ...
     */
    readonly nodeRole: IamIRoleRef | string;
    /**
     * The AMI version of the Amazon EKS optimized AMI to use with your node group (for example, `1.14.7- *YYYYMMDD*` ). By default, the latest available AMI version for the node group's current Kubernetes version is used. For more information, see [Amazon EKS optimized Linux AMI Versions](https://docs.aws.amazon.com/eks/latest/userguide/eks-linux-ami-versions.html) in the *Amazon EKS User Guide* .
     *
     ...
     */
    readonly subnets: Array<Ec2ISubnetRef | string>;
    /**
     * Metadata that assists with categorization and organization.
     *
     * Each tag consists of a key and an optional value. You define both. Tags don't propagate to any other cluster or AWS resources.
...
export declare class CfnCapability extends cdk.CfnResource implements cdk.IInspectable, ICapabilityRef, cdk.ITaggableV2 {
     ...
     */
    readonly attrConfigurationArgoCdAwsIdcIdcManagedApplicationArn: string;
    /**
     ...
     */
    readonly attrConfigurationArgoCdServerUrl: string;
    /**
