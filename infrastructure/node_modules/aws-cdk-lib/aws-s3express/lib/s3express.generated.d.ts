...
import { IBucketPolicyRef, BucketPolicyReference } from "../../interfaces/generated/aws-s3express-interfaces.generated";
 ...
 */
export declare class CfnDirectoryBucket extends cdk.CfnResource implements cdk.IInspectable, IDirectoryBucketRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnDirectoryBucket(x: any): x is CfnDirectoryBucket;
    /**
     * Creates a new IDirectoryBucketRef from an ARN
     */
    static fromDirectoryBucketArn(scope: constructs.Construct, id: string, arn: string): IDirectoryBucketRef;
    /**
     * Creates a new IDirectoryBucketRef from a bucketName
     */
    static fromBucketName(scope: constructs.Construct, id: string, bucketName: string): IDirectoryBucketRef;
    static arnForDirectoryBucket(resource: IDirectoryBucketRef): string;
    /**
    ...
    get directoryBucketRef(): DirectoryBucketReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IDirectoryBucketRef, DirectoryBucketReference };
