...
import { IClusterRef, ClusterReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IClusterParameterGroupRef, ClusterParameterGroupReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IClusterSecurityGroupRef, ClusterSecurityGroupReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IClusterSecurityGroupIngressRef, ClusterSecurityGroupIngressReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IClusterSubnetGroupRef, ClusterSubnetGroupReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IEndpointAccessRef, EndpointAccessReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IEndpointAuthorizationRef, EndpointAuthorizationReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IEventSubscriptionRef, EventSubscriptionReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IScheduledActionRef, ScheduledActionReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IIntegrationRef, IntegrationReference } from "../../interfaces/generated/aws-redshift-interfaces.generated";
import { IEIPRef as Ec2IEIPRef, ISecurityGroupRef as Ec2ISecurityGroupRef, ISubnetRef as Ec2ISubnetRef, IVPCRef as Ec2IVPCRef } from "../../aws-ec2";
import { IRoleRef as IamIRoleRef } from "../../aws-iam";
import { IKeyRef as KmsIKeyRef } from "../../aws-kms";
import { ITopicRef as SnsITopicRef } from "../../aws-sns";
/**
...
export interface CfnClusterProps {
     ...
     */
    readonly clusterParameterGroupName?: IClusterParameterGroupRef | string;
    /**
     * A list of security groups to be associated with this cluster.
     *
     ...
     */
    readonly clusterSecurityGroups?: Array<Ec2ISecurityGroupRef | IClusterSecurityGroupRef | string>;
    /**
     * The name of a cluster subnet group to be associated with this cluster.
     *
     ...
     */
    readonly clusterSubnetGroupName?: IClusterSubnetGroupRef | string;
    /**
     * The type of the cluster. When cluster type is specified as.
     *
     ...
     */
    readonly elasticIp?: Ec2IEIPRef | string;
    /**
     * If `true` , the data in the cluster is encrypted at rest.
     *
     ...
     */
    readonly iamRoles?: Array<IamIRoleRef | string>;
    /**
     * The AWS Key Management Service (KMS) key ID of the encryption key that you want to use to encrypt data in the cluster.
     *
     ...
     */
    readonly kmsKeyId?: KmsIKeyRef | string;
    /**
     * Specifies logging information, such as queries and connection attempts, for the specified Amazon Redshift cluster.
     *
     ...
     */
    readonly masterPasswordSecretKmsKeyId?: KmsIKeyRef | string;
    /**
     * The user name associated with the admin user account for the cluster that is being created.
     *
     * Constraints:
     ...
     */
    readonly vpcSecurityGroupIds?: Array<Ec2ISecurityGroupRef | string>;
}
/**
...
export declare class CfnClusterParameterGroup extends cdk.CfnResource implements cdk.IInspectable, IClusterParameterGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnClusterParameterGroup(x: any): x is CfnClusterParameterGroup;
    /**
     * Creates a new IClusterParameterGroupRef from a parameterGroupName
     */
    static fromParameterGroupName(scope: constructs.Construct, id: string, parameterGroupName: string): IClusterParameterGroupRef;
    static arnForClusterParameterGroup(resource: IClusterParameterGroupRef): string;
    /**
...
export declare class CfnClusterSecurityGroup extends cdk.CfnResource implements cdk.IInspectable, IClusterSecurityGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnClusterSecurityGroup(x: any): x is CfnClusterSecurityGroup;
    /**
     * @cloudformationAttribute Id
     */
    readonly attrId: string;
...
export declare class CfnClusterSecurityGroupIngress extends cdk.CfnResource implements cdk.IInspectable, IClusterSecurityGroupIngressRef {
     ...
     */
    static isCfnClusterSecurityGroupIngress(x: any): x is CfnClusterSecurityGroupIngress;
    /**
...
export declare class CfnClusterSubnetGroup extends cdk.CfnResource implements cdk.IInspectable, IClusterSubnetGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnClusterSubnetGroup(x: any): x is CfnClusterSubnetGroup;
    /**
...
export declare class CfnEndpointAccess extends cdk.CfnResource implements cdk.IInspectable, IEndpointAccessRef {
     ...
     */
    static isCfnEndpointAccess(x: any): x is CfnEndpointAccess;
    /**
...
export interface CfnEndpointAccessProps {
     ...
     */
    readonly subnetGroupName: IClusterSubnetGroupRef | string;
    /**
     * The security group that defines the ports, protocols, and sources for inbound traffic that you are authorizing into your endpoint.
     *
...
export declare class CfnEndpointAuthorization extends cdk.CfnResource implements cdk.IInspectable, IEndpointAuthorizationRef {
     ...
     */
    static isCfnEndpointAuthorization(x: any): x is CfnEndpointAuthorization;
    /**
...
export interface CfnEndpointAuthorizationProps {
     ...
     */
    readonly vpcIds?: Array<Ec2IVPCRef | string>;
}
/**
...
export interface CfnEventSubscriptionProps {
     ...
     */
    readonly snsTopicArn?: SnsITopicRef | string;
    /**
     * A list of one or more identifiers of Amazon Redshift source objects.
     *
...
export type { IClusterParameterGroupRef, ClusterParameterGroupReference };
export type { IClusterSecurityGroupRef, ClusterSecurityGroupReference };
export type { IClusterSecurityGroupIngressRef, ClusterSecurityGroupIngressReference };
export type { IClusterSubnetGroupRef, ClusterSubnetGroupReference };
export type { IEndpointAccessRef, EndpointAccessReference };
export type { IEndpointAuthorizationRef, EndpointAuthorizationReference };
