...
import { IConfigRef, ConfigReference } from "../../interfaces/generated/aws-groundstation-interfaces.generated";
import { IDataflowEndpointGroupRef, DataflowEndpointGroupReference } from "../../interfaces/generated/aws-groundstation-interfaces.generated";
import { IMissionProfileRef, MissionProfileReference } from "../../interfaces/generated/aws-groundstation-interfaces.generated";
/**
...
export declare class CfnConfig extends cdk.CfnResource implements cdk.IInspectable, IConfigRef, cdk.ITaggable {
     ...
     */
    static isCfnConfig(x: any): x is CfnConfig;
    static arnForConfig(resource: IConfigRef): string;
    /**
...
export declare class CfnDataflowEndpointGroup extends cdk.CfnResource implements cdk.IInspectable, IDataflowEndpointGroupRef, cdk.ITaggable {
     ...
     */
    static isCfnDataflowEndpointGroup(x: any): x is CfnDataflowEndpointGroup;
    /**
     * Creates a new IDataflowEndpointGroupRef from an ARN
     */
    static fromDataflowEndpointGroupArn(scope: constructs.Construct, id: string, arn: string): IDataflowEndpointGroupRef;
    /**
     * Creates a new IDataflowEndpointGroupRef from a dataflowEndpointGroupId
     */
    static fromDataflowEndpointGroupId(scope: constructs.Construct, id: string, dataflowEndpointGroupId: string): IDataflowEndpointGroupRef;
    static arnForDataflowEndpointGroup(resource: IDataflowEndpointGroupRef): string;
    /**
...
export declare class CfnMissionProfile extends cdk.CfnResource implements cdk.IInspectable, IMissionProfileRef, cdk.ITaggable {
     ...
     */
    static isCfnMissionProfile(x: any): x is CfnMissionProfile;
    /**
     * Creates a new IMissionProfileRef from a missionProfileId
     */
    static fromMissionProfileId(scope: constructs.Construct, id: string, missionProfileId: string): IMissionProfileRef;
    static arnForMissionProfile(resource: IMissionProfileRef): string;
    /**
...
export interface CfnMissionProfileProps {
     ...
     */
    readonly trackingConfigArn: IConfigRef | string;
}
export type { IConfigRef, ConfigReference };
export type { IDataflowEndpointGroupRef, DataflowEndpointGroupReference };
export type { IMissionProfileRef, MissionProfileReference };
