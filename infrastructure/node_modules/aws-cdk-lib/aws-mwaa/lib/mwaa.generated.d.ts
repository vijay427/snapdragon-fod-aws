...
import { IEnvironmentRef, EnvironmentReference } from "../../interfaces/generated/aws-mwaa-interfaces.generated";
...
export declare class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentRef, cdk.ITaggable {
     ...
     */
    static fromEnvironmentName(scope: constructs.Construct, id: string, environmentName: string): IEnvironmentRef;
...
export interface CfnEnvironmentProps {
     ...
     */
    readonly kmsKey?: KmsIKeyRef | string;
    /**
     * The Apache Airflow logs being sent to CloudWatch Logs: `DagProcessingLogs` , `SchedulerLogs` , `TaskLogs` , `WebserverLogs` , `WorkerLogs` .
     *
     ...
     */
    readonly sourceBucketArn?: S3IBucketRef | string;
    /**
     * The version of the startup shell script in your Amazon S3 bucket.
     *
