...
import { IFleetRef, FleetReference } from "../../interfaces/generated/aws-robomaker-interfaces.generated";
import { IRobotRef, RobotReference } from "../../interfaces/generated/aws-robomaker-interfaces.generated";
import { IRobotApplicationRef, RobotApplicationReference } from "../../interfaces/generated/aws-robomaker-interfaces.generated";
import { IRobotApplicationVersionRef, RobotApplicationVersionReference } from "../../interfaces/generated/aws-robomaker-interfaces.generated";
import { ISimulationApplicationRef, SimulationApplicationReference } from "../../interfaces/generated/aws-robomaker-interfaces.generated";
import { ISimulationApplicationVersionRef, SimulationApplicationVersionReference } from "../../interfaces/generated/aws-robomaker-interfaces.generated";
/**
...
export declare class CfnRobot extends cdk.CfnResource implements cdk.IInspectable, IRobotRef, cdk.ITaggable {
     ...
     */
    static isCfnRobot(x: any): x is CfnRobot;
    static arnForRobot(resource: IRobotRef): string;
    /**
...
export interface CfnRobotProps {
     ...
     */
    readonly fleet?: IFleetRef | string;
    /**
     * The Greengrass group associated with the robot.
     *
...
export declare class CfnRobotApplication extends cdk.CfnResource implements cdk.IInspectable, IRobotApplicationRef, cdk.ITaggable {
     ...
     */
    static isCfnRobotApplication(x: any): x is CfnRobotApplication;
    static arnForRobotApplication(resource: IRobotApplicationRef): string;
    /**
...
export declare class CfnRobotApplicationVersion extends cdk.CfnResource implements cdk.IInspectable, IRobotApplicationVersionRef {
     ...
     */
    static isCfnRobotApplicationVersion(x: any): x is CfnRobotApplicationVersion;
    static arnForRobotApplicationVersion(resource: IRobotApplicationVersionRef): string;
    /**
...
export interface CfnRobotApplicationVersionProps {
     ...
     */
    readonly application: IRobotApplicationRef | string;
    /**
     * The current revision id for the robot application.
     *
...
export declare class CfnSimulationApplication extends cdk.CfnResource implements cdk.IInspectable, ISimulationApplicationRef, cdk.ITaggable {
     ...
     */
    static isCfnSimulationApplication(x: any): x is CfnSimulationApplication;
    static arnForSimulationApplication(resource: ISimulationApplicationRef): string;
    /**
...
export declare class CfnSimulationApplicationVersion extends cdk.CfnResource implements cdk.IInspectable, ISimulationApplicationVersionRef {
     ...
     */
    static isCfnSimulationApplicationVersion(x: any): x is CfnSimulationApplicationVersion;
    static arnForSimulationApplicationVersion(resource: ISimulationApplicationVersionRef): string;
    /**
...
export interface CfnSimulationApplicationVersionProps {
     ...
     */
    readonly application: ISimulationApplicationRef | string;
    /**
     * The current revision id for the simulation application.
     *
     * If you provide a value and it matches the latest revision ID, a new version will be created.
...
export type { IRobotRef, RobotReference };
export type { IRobotApplicationRef, RobotApplicationReference };
export type { IRobotApplicationVersionRef, RobotApplicationVersionReference };
export type { ISimulationApplicationRef, SimulationApplicationReference };
export type { ISimulationApplicationVersionRef, SimulationApplicationVersionReference };
