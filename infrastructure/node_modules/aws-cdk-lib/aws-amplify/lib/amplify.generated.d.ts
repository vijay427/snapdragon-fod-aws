...
import { IAppRef, AppReference } from "../../interfaces/generated/aws-amplify-interfaces.generated";
import { IBranchRef, BranchReference } from "../../interfaces/generated/aws-amplify-interfaces.generated";
import { IDomainRef, DomainReference } from "../../interfaces/generated/aws-amplify-interfaces.generated";
...
export interface CfnAppProps {
     ...
     */
    readonly iamServiceRole?: IamIRoleRef | string;
    /**
     * The configuration details that apply to the jobs for an Amplify app.
     *
...
export interface CfnDomainProps {
     ...
     */
    readonly autoSubDomainIamRole?: IamIRoleRef | string;
    /**
     * The type of SSL/TLS certificate to use for your custom domain.
     *
...
export type { IBranchRef, BranchReference };
