...
import { ISimulationRef, SimulationReference } from "../../interfaces/generated/aws-simspaceweaver-interfaces.generated";
/**
...
export declare class CfnSimulation extends cdk.CfnResource implements cdk.IInspectable, ISimulationRef {
     ...
     */
    static isCfnSimulation(x: any): x is CfnSimulation;
    /**
     * Creates a new ISimulationRef from a simulationName
     */
    static fromSimulationName(scope: constructs.Construct, id: string, simulationName: string): ISimulationRef;
    static arnForSimulation(resource: ISimulationRef): string;
    /**
...
export type { ISimulationRef, SimulationReference };
