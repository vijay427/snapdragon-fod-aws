...
import { IChannelRef, ChannelReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IPlaybackKeyPairRef, PlaybackKeyPairReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IRecordingConfigurationRef, RecordingConfigurationReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IStreamKeyRef, StreamKeyReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IEncoderConfigurationRef, EncoderConfigurationReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IIngestConfigurationRef, IngestConfigurationReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IPlaybackRestrictionPolicyRef, PlaybackRestrictionPolicyReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IPublicKeyRef, PublicKeyReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IStageRef, StageReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
import { IStorageConfigurationRef, StorageConfigurationReference } from "../../interfaces/generated/aws-ivs-interfaces.generated";
/**
...
export interface CfnChannelProps {
     ...
     */
    readonly recordingConfigurationArn?: IRecordingConfigurationRef | string;
    /**
     * A list of key-value pairs that contain metadata for the asset model.
     *
...
export declare class CfnPlaybackKeyPair extends cdk.CfnResource implements cdk.IInspectable, IPlaybackKeyPairRef, cdk.ITaggable {
     ...
     */
    static isCfnPlaybackKeyPair(x: any): x is CfnPlaybackKeyPair;
    static arnForPlaybackKeyPair(resource: IPlaybackKeyPairRef): string;
    /**
...
export declare class CfnRecordingConfiguration extends cdk.CfnResource implements cdk.IInspectable, IRecordingConfigurationRef, cdk.ITaggable {
     ...
     */
    static isCfnRecordingConfiguration(x: any): x is CfnRecordingConfiguration;
    static arnForRecordingConfiguration(resource: IRecordingConfigurationRef): string;
    /**
...
export declare class CfnStreamKey extends cdk.CfnResource implements cdk.IInspectable, IStreamKeyRef, cdk.ITaggable {
     ...
     */
    static isCfnStreamKey(x: any): x is CfnStreamKey;
    static arnForStreamKey(resource: IStreamKeyRef): string;
    /**
...
export interface CfnStreamKeyProps {
     ...
     */
    readonly channelArn: IChannelRef | string;
    /**
     * An array of key-value pairs to apply to this resource.
     *
...
export declare class CfnEncoderConfiguration extends cdk.CfnResource implements cdk.IInspectable, IEncoderConfigurationRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnEncoderConfiguration(x: any): x is CfnEncoderConfiguration;
    static arnForEncoderConfiguration(resource: IEncoderConfigurationRef): string;
    /**
...
export declare class CfnIngestConfiguration extends cdk.CfnResource implements cdk.IInspectable, IIngestConfigurationRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnIngestConfiguration(x: any): x is CfnIngestConfiguration;
    static arnForIngestConfiguration(resource: IIngestConfigurationRef): string;
    /**
...
export declare class CfnPlaybackRestrictionPolicy extends cdk.CfnResource implements cdk.IInspectable, IPlaybackRestrictionPolicyRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnPlaybackRestrictionPolicy(x: any): x is CfnPlaybackRestrictionPolicy;
    static arnForPlaybackRestrictionPolicy(resource: IPlaybackRestrictionPolicyRef): string;
    /**
...
export declare class CfnPublicKey extends cdk.CfnResource implements cdk.IInspectable, IPublicKeyRef, cdk.ITaggableV2 {
    ...
    static arnForPublicKey(resource: IPublicKeyRef): string;
    /**
...
export declare class CfnStage extends cdk.CfnResource implements cdk.IInspectable, IStageRef, cdk.ITaggableV2 {
    ...
    static arnForStage(resource: IStageRef): string;
    /**
...
export declare class CfnStorageConfiguration extends cdk.CfnResource implements cdk.IInspectable, IStorageConfigurationRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnStorageConfiguration(x: any): x is CfnStorageConfiguration;
    static arnForStorageConfiguration(resource: IStorageConfigurationRef): string;
    /**
...
export type { IPlaybackKeyPairRef, PlaybackKeyPairReference };
export type { IRecordingConfigurationRef, RecordingConfigurationReference };
export type { IStreamKeyRef, StreamKeyReference };
export type { IEncoderConfigurationRef, EncoderConfigurationReference };
export type { IIngestConfigurationRef, IngestConfigurationReference };
export type { IPlaybackRestrictionPolicyRef, PlaybackRestrictionPolicyReference };
export type { IPublicKeyRef, PublicKeyReference };
export type { IStageRef, StageReference };
export type { IStorageConfigurationRef, StorageConfigurationReference };
