...
import { IAnomalyDetectorRef, AnomalyDetectorReference } from "../../interfaces/generated/aws-cloudwatch-interfaces.generated";
import { ICompositeAlarmRef, CompositeAlarmReference } from "../../interfaces/generated/aws-cloudwatch-interfaces.generated";
import { IDashboardRef, DashboardReference } from "../../interfaces/generated/aws-cloudwatch-interfaces.generated";
import { IInsightRuleRef, InsightRuleReference } from "../../interfaces/generated/aws-cloudwatch-interfaces.generated";
import { IMetricStreamRef, MetricStreamReference } from "../../interfaces/generated/aws-cloudwatch-interfaces.generated";
import { IScalingPolicyRef as AutoScalingIScalingPolicyRef } from "../../aws-autoscaling";
...
export interface CfnAlarmProps {
     ...
     */
    readonly alarmActions?: Array<AutoScalingIScalingPolicyRef | SnsITopicRef | string>;
    /**
     * The description of the alarm.
     *
     ...
     */
    readonly insufficientDataActions?: Array<SnsITopicRef | string>;
    /**
     * The name of the metric associated with the alarm.
     *
     ...
     */
    readonly okActions?: Array<SnsITopicRef | string>;
    /**
     * The period, in seconds, over which the statistic is applied.
     *
...
export interface CfnCompositeAlarmProps {
     ...
     */
    readonly actionsSuppressor?: IAlarmRef | ICompositeAlarmRef | string;
    /**
     * The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state.
     *
     ...
     */
    readonly alarmActions?: Array<SnsITopicRef | string>;
    /**
     * The description for the composite alarm.
     *
...
export interface CfnMetricStreamProps {
     ...
     */
    readonly firehoseArn: KinesisFirehoseIDeliveryStreamRef | string;
    /**
     * If you specify this parameter, the stream sends only the metrics from the metric namespaces that you specify here.
     *
     * You cannot specify both `IncludeFilters` and `ExcludeFilters` in the same metric stream.
