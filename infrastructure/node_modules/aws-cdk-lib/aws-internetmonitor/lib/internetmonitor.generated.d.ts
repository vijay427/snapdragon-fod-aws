...
import { IMonitorRef, MonitorReference } from "../../interfaces/generated/aws-internetmonitor-interfaces.generated";
/**
...
export declare class CfnMonitor extends cdk.CfnResource implements cdk.IInspectable, IMonitorRef, cdk.ITaggable {
     ...
     */
    static fromMonitorArn(scope: constructs.Construct, id: string, arn: string): IMonitorRef;
    /**
     * Creates a new IMonitorRef from a monitorName
     */
    static fromMonitorName(scope: constructs.Construct, id: string, monitorName: string): IMonitorRef;
