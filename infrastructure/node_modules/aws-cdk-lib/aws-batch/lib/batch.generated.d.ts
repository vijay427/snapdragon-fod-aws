...
import { IComputeEnvironmentRef, ComputeEnvironmentReference } from "../../interfaces/generated/aws-batch-interfaces.generated";
import { IJobDefinitionRef, JobDefinitionReference } from "../../interfaces/generated/aws-batch-interfaces.generated";
import { IJobQueueRef, JobQueueReference } from "../../interfaces/generated/aws-batch-interfaces.generated";
import { ISchedulingPolicyRef, SchedulingPolicyReference } from "../../interfaces/generated/aws-batch-interfaces.generated";
import { IConsumableResourceRef, ConsumableResourceReference } from "../../interfaces/generated/aws-batch-interfaces.generated";
import { IServiceEnvironmentRef, ServiceEnvironmentReference } from "../../interfaces/generated/aws-batch-interfaces.generated";
...
export declare class CfnComputeEnvironment extends cdk.CfnResource implements cdk.IInspectable, IComputeEnvironmentRef, cdk.ITaggable {
     ...
     */
    static isCfnComputeEnvironment(x: any): x is CfnComputeEnvironment;
    static arnForComputeEnvironment(resource: IComputeEnvironmentRef): string;
    /**
...
export interface CfnComputeEnvironmentProps {
     ...
     */
    readonly serviceRole?: IamIRoleRef | string;
    /**
     * The state of the compute environment.
     *
...
export declare class CfnJobDefinition extends cdk.CfnResource implements cdk.IInspectable, IJobDefinitionRef, cdk.ITaggable {
     ...
     */
    static isCfnJobDefinition(x: any): x is CfnJobDefinition;
    /**
     * Creates a new IJobDefinitionRef from an ARN
     */
    static fromJobDefinitionArn(scope: constructs.Construct, id: string, arn: string): IJobDefinitionRef;
    /**
     * Creates a new IJobDefinitionRef from a jobDefinitionName
     */
    static fromJobDefinitionName(scope: constructs.Construct, id: string, jobDefinitionName: string): IJobDefinitionRef;
    static arnForJobDefinition(resource: IJobDefinitionRef): string;
    /**
     ...
     */
    resourceRetentionPolicy?: cdk.IResolvable | CfnJobDefinition.ResourceRetentionPolicyProperty;
    /**
...
export declare namespace CfnJobDefinition {
    ...
    interface ResourceRetentionPolicyProperty {
         ...
         */
        readonly skipDeregisterOnUpdate?: boolean | cdk.IResolvable;
    }
}
/**
...
export interface CfnJobDefinitionProps {
     ...
     */
    readonly resourceRetentionPolicy?: cdk.IResolvable | CfnJobDefinition.ResourceRetentionPolicyProperty;
    /**
     * The retry strategy to use for failed jobs that are submitted with this job definition.
     *
...
export declare class CfnJobQueue extends cdk.CfnResource implements cdk.IInspectable, IJobQueueRef, cdk.ITaggable {
     ...
     */
    static isCfnJobQueue(x: any): x is CfnJobQueue;
    static arnForJobQueue(resource: IJobQueueRef): string;
    /**
...
export interface CfnJobQueueProps {
     ...
     */
    readonly schedulingPolicyArn?: ISchedulingPolicyRef | string;
    /**
     * The order of the service environment associated with the job queue.
     *
     * Job queues with a higher priority are evaluated first when associated with the same service environment.
...
export declare class CfnSchedulingPolicy extends cdk.CfnResource implements cdk.IInspectable, ISchedulingPolicyRef, cdk.ITaggable {
     ...
     */
    static isCfnSchedulingPolicy(x: any): x is CfnSchedulingPolicy;
    static arnForSchedulingPolicy(resource: ISchedulingPolicyRef): string;
    /**
...
export declare class CfnConsumableResource extends cdk.CfnResource implements cdk.IInspectable, IConsumableResourceRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnConsumableResource(x: any): x is CfnConsumableResource;
    static arnForConsumableResource(resource: IConsumableResourceRef): string;
    /**
...
export declare class CfnServiceEnvironment extends cdk.CfnResource implements cdk.IInspectable, IServiceEnvironmentRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnServiceEnvironment(x: any): x is CfnServiceEnvironment;
    static arnForServiceEnvironment(resource: IServiceEnvironmentRef): string;
    /**
...
export type { IComputeEnvironmentRef, ComputeEnvironmentReference };
export type { IJobDefinitionRef, JobDefinitionReference };
export type { IJobQueueRef, JobQueueReference };
export type { ISchedulingPolicyRef, SchedulingPolicyReference };
export type { IConsumableResourceRef, ConsumableResourceReference };
export type { IServiceEnvironmentRef, ServiceEnvironmentReference };
