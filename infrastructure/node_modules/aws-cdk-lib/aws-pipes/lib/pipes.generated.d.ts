...
import { IPipeRef, PipeReference } from "../../interfaces/generated/aws-pipes-interfaces.generated";
import { IEventBusRef as EventsIEventBusRef } from "../../aws-events";
...
import { IStateMachineRef as StepFunctionsIStateMachineRef } from "../../aws-stepfunctions";
/**
 * Specifies a pipe.
 *
...
export declare class CfnPipe extends cdk.CfnResource implements cdk.IInspectable, IPipeRef, cdk.ITaggable {
     ...
     */
    static isCfnPipe(x: any): x is CfnPipe;
    static arnForPipe(resource: IPipeRef): string;
    /**
     * The ARN of the pipe.
     *
...
export interface CfnPipeProps {
     ...
     */
    readonly enrichment?: LambdaIFunctionRef | string;
    /**
     * The parameters required to set up enrichment on your pipe.
     *
     ...
     */
    readonly source: KinesisIStreamRef | SqsIQueueRef | string;
    /**
     * The parameters required to set up a source for your pipe.
     *
     ...
     */
    readonly target: EventsIEventBusRef | LambdaIFunctionRef | LogsILogGroupRef | SnsITopicRef | SqsIQueueRef | StepFunctionsIStateMachineRef | string;
    /**
     * The parameters required to set up a target for your pipe.
     *
     * For more information about pipe target parameters, including how to use dynamic path parameters, see [Target parameters](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes-event-target.html) in the *Amazon EventBridge User Guide* .
...
export type { IPipeRef, PipeReference };
