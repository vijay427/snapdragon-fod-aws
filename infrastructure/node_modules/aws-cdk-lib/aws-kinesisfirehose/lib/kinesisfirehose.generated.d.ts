...
import { IDeliveryStreamRef, DeliveryStreamReference } from "../../interfaces/generated/aws-kinesisfirehose-interfaces.generated";
...
export declare class CfnDeliveryStream extends cdk.CfnResource implements cdk.IInspectable, IDeliveryStreamRef, cdk.ITaggable {
     ...
     */
    static isCfnDeliveryStream(x: any): x is CfnDeliveryStream;
    /**
     * Creates a new IDeliveryStreamRef from an ARN
     */
    static fromDeliveryStreamArn(scope: constructs.Construct, id: string, arn: string): IDeliveryStreamRef;
    /**
     * Creates a new IDeliveryStreamRef from a deliveryStreamName
     */
    static fromDeliveryStreamName(scope: constructs.Construct, id: string, deliveryStreamName: string): IDeliveryStreamRef;
    static arnForDeliveryStream(resource: IDeliveryStreamRef): string;
    /**
...
export interface CfnDeliveryStreamProps {
     ...
     */
    readonly deliveryStreamName?: KinesisIStreamRef | string;
    /**
     * The Firehose stream type. This can be one of the following values:.
     *
...
export type { IDeliveryStreamRef, DeliveryStreamReference };
