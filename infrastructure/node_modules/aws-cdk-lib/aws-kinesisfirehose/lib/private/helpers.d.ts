...
export declare function createBufferingHints(scope: Construct, interval?: cdk.Duration, size?: cdk.Size, dataFormatConversionConfiguration?: CfnDeliveryStream.DataFormatConversionConfigurationProperty): CfnDeliveryStream.BufferingHintsProperty | undefined;
...
export declare function createProcessingConfig(scope: Construct, role: iam.IRole, dataProcessors?: IDataProcessor[]): CfnDeliveryStream.ProcessingConfigurationProperty | undefined;
