...
import { IBackupPlanRef, BackupPlanReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { IBackupSelectionRef, BackupSelectionReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { IBackupVaultRef, BackupVaultReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { IFrameworkRef, FrameworkReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { IReportPlanRef, ReportPlanReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { ILogicallyAirGappedBackupVaultRef, LogicallyAirGappedBackupVaultReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { IRestoreTestingPlanRef, RestoreTestingPlanReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { IRestoreTestingSelectionRef, RestoreTestingSelectionReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
...
export declare class CfnBackupPlan extends cdk.CfnResource implements cdk.IInspectable, IBackupPlanRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnBackupPlan(x: any): x is CfnBackupPlan;
    /**
     * Creates a new IBackupPlanRef from an ARN
     */
    static fromBackupPlanArn(scope: constructs.Construct, id: string, arn: string): IBackupPlanRef;
    /**
     * Creates a new IBackupPlanRef from a backupPlanId
     */
    static fromBackupPlanId(scope: constructs.Construct, id: string, backupPlanId: string): IBackupPlanRef;
    static arnForBackupPlan(resource: IBackupPlanRef): string;
    /**
...
export declare class CfnBackupSelection extends cdk.CfnResource implements cdk.IInspectable, IBackupSelectionRef {
     ...
     */
    static isCfnBackupSelection(x: any): x is CfnBackupSelection;
    /**
     * Uniquely identifies a backup plan.
     *
     * @cloudformationAttribute BackupPlanId
...
export interface CfnBackupSelectionProps {
     ...
     */
    readonly backupPlanId: IBackupPlanRef | string;
    /**
     * Specifies the body of a request to assign a set of resources to a backup plan.
     *
...
export declare class CfnBackupVault extends cdk.CfnResource implements cdk.IInspectable, IBackupVaultRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnBackupVault(x: any): x is CfnBackupVault;
    /**
     * Creates a new IBackupVaultRef from an ARN
     */
    static fromBackupVaultArn(scope: constructs.Construct, id: string, arn: string): IBackupVaultRef;
    /**
     * Creates a new IBackupVaultRef from a backupVaultName
     */
    static fromBackupVaultName(scope: constructs.Construct, id: string, backupVaultName: string): IBackupVaultRef;
    static arnForBackupVault(resource: IBackupVaultRef): string;
    /**
...
export interface CfnBackupVaultProps {
     ...
     */
    readonly encryptionKeyArn?: KmsIKeyRef | string;
    /**
     * Configuration for [AWS Backup Vault Lock](https://docs.aws.amazon.com/aws-backup/latest/devguide/vault-lock.html) .
     *
...
export declare class CfnFramework extends cdk.CfnResource implements cdk.IInspectable, IFrameworkRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnFramework(x: any): x is CfnFramework;
    static arnForFramework(resource: IFrameworkRef): string;
    /**
...
export declare class CfnReportPlan extends cdk.CfnResource implements cdk.IInspectable, IReportPlanRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnReportPlan(x: any): x is CfnReportPlan;
    static arnForReportPlan(resource: IReportPlanRef): string;
    /**
...
export declare class CfnLogicallyAirGappedBackupVault extends cdk.CfnResource implements cdk.IInspectable, ILogicallyAirGappedBackupVaultRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnLogicallyAirGappedBackupVault(x: any): x is CfnLogicallyAirGappedBackupVault;
    /**
     * Creates a new ILogicallyAirGappedBackupVaultRef from a backupVaultName
     */
    static fromBackupVaultName(scope: constructs.Construct, id: string, backupVaultName: string): ILogicallyAirGappedBackupVaultRef;
    static arnForLogicallyAirGappedBackupVault(resource: ILogicallyAirGappedBackupVaultRef): string;
    /**
...
export declare class CfnRestoreTestingPlan extends cdk.CfnResource implements cdk.IInspectable, IRestoreTestingPlanRef, cdk.ITaggableV2 {
     ...
     */
    static isCfnRestoreTestingPlan(x: any): x is CfnRestoreTestingPlan;
    static arnForRestoreTestingPlan(resource: IRestoreTestingPlanRef): string;
    /**
...
export declare class CfnRestoreTestingSelection extends cdk.CfnResource implements cdk.IInspectable, IRestoreTestingSelectionRef {
     ...
     */
    static isCfnRestoreTestingSelection(x: any): x is CfnRestoreTestingSelection;
    /**
...
export type { IBackupPlanRef, BackupPlanReference };
export type { IBackupSelectionRef, BackupSelectionReference };
export type { IBackupVaultRef, BackupVaultReference };
export type { IFrameworkRef, FrameworkReference };
export type { IReportPlanRef, ReportPlanReference };
export type { ILogicallyAirGappedBackupVaultRef, LogicallyAirGappedBackupVaultReference };
export type { IRestoreTestingPlanRef, RestoreTestingPlanReference };
export type { IRestoreTestingSelectionRef, RestoreTestingSelectionReference };
