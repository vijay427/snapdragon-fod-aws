...
import { IAliasRef, AliasReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { ICodeSigningConfigRef, CodeSigningConfigReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { IEventInvokeConfigRef, EventInvokeConfigReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { IEventSourceMappingRef, EventSourceMappingReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { IFunctionRef, FunctionReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { ILayerVersionRef, LayerVersionReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { ILayerVersionPermissionRef, LayerVersionPermissionReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { IPermissionRef, PermissionReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { IUrlRef, UrlReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { IVersionRef, VersionReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { ICapacityProviderRef, CapacityProviderReference } from "../../interfaces/generated/aws-lambda-interfaces.generated";
import { IUserPoolRef as CognitoIUserPoolRef } from "../../aws-cognito";
import { IRuleRef as EventsIRuleRef } from "../../aws-events";
import { IRoleRef as IamIRoleRef, IUserRef as IamIUserRef } from "../../aws-iam";
import { ITopicRuleRef as IoTITopicRuleRef } from "../../aws-iot";
import { IStreamRef as KinesisIStreamRef } from "../../aws-kinesis";
import { IDeliveryStreamRef as KinesisFirehoseIDeliveryStreamRef } from "../../aws-kinesisfirehose";
import { IKeyRef as KmsIKeyRef } from "../../aws-kms";
import { ILogGroupRef as LogsILogGroupRef } from "../../aws-logs";
import { IClusterRef as MskIClusterRef } from "../../aws-msk";
import { IBucketRef as S3IBucketRef } from "../../aws-s3";
import { ITopicRef as SnsITopicRef } from "../../aws-sns";
import { IQueueRef as SqsIQueueRef } from "../../aws-sqs";
/**
...
export interface CfnEventInvokeConfigProps {
     ...
     */
    readonly functionName: IFunctionRef | string;
    /**
     * The maximum age of a request that Lambda sends to a function for processing.
     *
...
export interface CfnEventSourceMappingProps {
     ...
     */
    readonly eventSourceArn?: KinesisIStreamRef | MskIClusterRef | SqsIQueueRef | string;
    /**
     * An object that defines the filter criteria that determine whether Lambda should process an event.
     *
     ...
     */
    readonly functionName: IFunctionRef | IVersionRef | string;
    /**
     * (Kinesis, DynamoDB Streams, and SQS) A list of current response type enums applied to the event source mapping.
     *
...
export interface CfnFunctionProps {
     ...
     */
    readonly codeSigningConfigArn?: ICodeSigningConfigRef | string;
    /**
     * A dead-letter queue configuration that specifies the queue or topic where Lambda sends asynchronous events when they fail processing.
     *
     ...
     */
    readonly kmsKeyArn?: KmsIKeyRef | string;
    /**
     * A list of [function layers](https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html) to add to the function's execution environment. Specify each layer by its ARN, including the version.
     *
     ...
     */
    readonly layers?: Array<ILayerVersionRef | string>;
    /**
     * The function's Amazon CloudWatch Logs configuration settings.
     *
...
export interface CfnLayerVersionPermissionProps {
     ...
     */
    readonly layerVersionArn: ILayerVersionRef | string;
    /**
     * With the principal set to `*` , grant permission to all accounts in the specified organization.
     *
...
export interface CfnPermissionProps {
     ...
     */
    readonly principal: IamIRoleRef | IamIUserRef | string;
    /**
     * The identifier for your organization in AWS Organizations .
     *
     ...
     */
    readonly sourceArn?: CognitoIUserPoolRef | EventsIRuleRef | IamIRoleRef | IFunctionRef | IoTITopicRuleRef | KinesisFirehoseIDeliveryStreamRef | LogsILogGroupRef | S3IBucketRef | SnsITopicRef | SqsIQueueRef | string;
}
/**
...
export interface CfnUrlProps {
     ...
     */
    readonly targetFunctionArn: IFunctionRef | string;
}
/**
